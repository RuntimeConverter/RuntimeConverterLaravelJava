...
public class HasOne extends HasOneOrMany {
    ...
    public HasOne(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == HasOne.class) {
            this.__construct(env, args);
        }
    }

    public HasOne(NoConstructor n) {
        super(n);
    }
    ...
    public Object initRelation(RuntimeEnv env, Object... args) {
        ...
        Object model = null;
        for (ZPair zpairResult321 : ZVal.getIterable(models, env, true)) {
            model = ZVal.assign(zpairResult321.getValue());
            env.callMethod(
                    model, "setRelation", HasOne.class, relation, this.getDefaultFor(env, model));
        }
    ...
    public Object match(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                env.callMethod(this, "matchOne", HasOne.class, models, results, relation));
    }
    ...
    public Object newRelatedInstanceFor(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                env.callMethod(
                        ...
                        "setAttribute",
                        HasOne.class,
                        env.callMethod(this, "getForeignKeyName", HasOne.class),
                        toObjectR(parent)
                                .accessProp(this, env)
                                .name(
                                        toObjectR(this)
    ...
    protected Object getDefaultFor(RuntimeEnv env, Object... args) {
        ...
        if (function_is_array.f.env(env).call(this.withDefault).getBool()) {
            env.callMethod(instance, "forceFill", HasOne.class, this.withDefault);
        }

        return ZVal.assign(instance);
    }

    public static final Object CONST_class = "Illuminate\\Database\\Eloquent\\Relations\\HasOne";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Database\\Eloquent\\Relations\\HasOne")
                    .setLookup(
                            HasOne.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties(
                            "foreignKey", "localKey", "parent", "query", "related", "withDefault")
                    .setFilename(
                            "vendor/laravel/framework/src/Illuminate/Database/Eloquent/Relations/HasOne.php")
                    .addTrait(
