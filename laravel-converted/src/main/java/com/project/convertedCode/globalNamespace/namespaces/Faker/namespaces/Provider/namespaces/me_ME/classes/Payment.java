...
public class Payment
    ...
    public static final Object CONST_class = "Faker\\Provider\\me_ME\\Payment";
    ...
    public static class RuntimeStaticCompanion
        ...
        @ConvertedParameter(index = 2, name = "length")
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\me_ME\\Payment")
                    .setLookup(
                            Payment.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/me_ME/Payment.php")
