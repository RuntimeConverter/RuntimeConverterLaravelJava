...
public class RandomBytesGenerator extends RuntimeClassBase implements RandomGeneratorInterface {

    public RandomBytesGenerator(RuntimeEnv env, Object... args) {
        super(env);
    }

    public RandomBytesGenerator(NoConstructor n) {
        super(n);
    }
    ...
    public Object generate(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(function_random_bytes.f.env(env).call(length).value());
    }

    public static final Object CONST_class = "Ramsey\\Uuid\\Generator\\RandomBytesGenerator";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Ramsey\\Uuid\\Generator\\RandomBytesGenerator")
                    .setLookup(
                            RandomBytesGenerator.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/ramsey/uuid/src/Generator/RandomBytesGenerator.php")
