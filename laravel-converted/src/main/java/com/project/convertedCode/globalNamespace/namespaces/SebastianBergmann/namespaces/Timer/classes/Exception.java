...
public interface Exception {
    ...
    public static final Object CONST_class = "SebastianBergmann\\Timer\\Exception";

    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("SebastianBergmann\\Timer\\Exception")
                    .setLookup(Exception.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/phpunit/php-timer/src/Exception.php")
                    .get();
}
