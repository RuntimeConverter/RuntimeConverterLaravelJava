...
public class TLD extends Warning {
    ...
    public TLD(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == TLD.class) {
            this.__construct(env, args);
        }
    }

    public TLD(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("RFC5321, TLD");
        return null;
    }

    public static final Object CONST_CODE = 9;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\TLD";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\TLD")
                    .setLookup(
                            TLD.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("message", "rfcNumber")
                    .setFilename("vendor/egulias/email-validator/EmailValidator/Warning/TLD.php")
