...
public interface SessionInterface {
    ...
    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpFoundation\\Session\\SessionInterface")
                    .setLookup(SessionInterface.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/symfony/http-foundation/Session/SessionInterface.php")
                    .get();
}
