...
public class array_has extends FunctionBaseRegular {

    public static array_has f = new array_has();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(Arr.runtimeStaticObject.has(env, array, keys));
    }
