...
public class ConfigClearCommand extends Command {

    public Object files = null;

    public ConfigClearCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "config:clear";
        this.description = "Remove the configuration cache file";
        if (this.getClass() == ConfigClearCommand.class) {
            this.__construct(env, args);
        }
    }

    public ConfigClearCommand(NoConstructor n) {
        super(n);
    }
    ...
    public Object handle(RuntimeEnv env, Object... args) {
        env.callMethod(
                ...
                env.callMethod(
                        ...
                        "getCachedConfigPath",
                        ConfigClearCommand.class));
        env.callMethod(this, "info", ConfigClearCommand.class, "Configuration cache cleared!");
        return null;
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\ConfigClearCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\ConfigClearCommand")
                    .setLookup(
                            ConfigClearCommand.class,
