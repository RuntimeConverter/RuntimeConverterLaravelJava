...
public class Comment extends Warning {
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("Comments found in this email");
        return null;
    }

    public static final Object CONST_CODE = 17;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\Comment";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\Comment")
                    .setLookup(
                            Comment.class,
