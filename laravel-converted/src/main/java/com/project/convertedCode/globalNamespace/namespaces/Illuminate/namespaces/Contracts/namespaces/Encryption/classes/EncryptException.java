...
public class EncryptException extends RuntimeException {
    ...
    public EncryptException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == EncryptException.class) {
            this.__construct(env, args);
        }
    }

    public EncryptException(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Contracts\\Encryption\\EncryptException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Contracts\\Encryption\\EncryptException")
                    .setLookup(
