...
public class Array_ extends Cast {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Cast\\Array_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Cast\\Array_")
                    .setLookup(
                            Array_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Array_.php")
