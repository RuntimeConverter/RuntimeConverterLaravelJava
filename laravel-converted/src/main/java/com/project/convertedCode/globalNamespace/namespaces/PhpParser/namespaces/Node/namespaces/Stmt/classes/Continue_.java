...
public class Continue_ extends Stmt {

    public Object num = null;

    public Continue_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Continue_.class) {
            this.__construct(env, args);
        }
    }

    public Continue_(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object num = assignParameter(args, 0, true);
        if (null == num) {
            num = ZVal.getNull();
        }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("num"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Continue_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Continue_")
                    .setLookup(
                            Continue_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "num")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Continue_.php")
