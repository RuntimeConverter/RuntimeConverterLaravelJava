...
public class PreconditionFailedHttpException extends HttpException {
    ...
    public PreconditionFailedHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PreconditionFailedHttpException.class) {
            this.__construct(env, args);
        }
    }

    public PreconditionFailedHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 412, message, previous, headers, code);
        return null;
    }
