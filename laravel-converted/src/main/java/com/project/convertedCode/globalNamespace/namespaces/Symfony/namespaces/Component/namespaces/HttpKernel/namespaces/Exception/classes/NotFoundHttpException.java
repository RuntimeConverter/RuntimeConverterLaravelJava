...
public class NotFoundHttpException extends HttpException {
    ...
    public NotFoundHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NotFoundHttpException.class) {
            this.__construct(env, args);
        }
    }

    public NotFoundHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 404, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\NotFoundHttpException")
                    .setLookup(
                            NotFoundHttpException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("headers", "statusCode")
                    .setFilename("vendor/symfony/http-kernel/Exception/NotFoundHttpException.php")
                    .addInterface(
