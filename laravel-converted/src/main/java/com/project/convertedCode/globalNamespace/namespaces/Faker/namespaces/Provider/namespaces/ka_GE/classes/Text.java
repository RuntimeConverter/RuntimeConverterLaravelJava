...
public class Text
    ...
    public static final Object CONST_class = "Faker\\Provider\\ka_GE\\Text";
    ...
    public static class RequestStaticProperties {
        ...
        public Object textStartsWithUppercase = false;

        public Object baseText = ZVal.getResourceAsString("stringLiterals/stringLiteral464.txt");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\ka_GE\\Text")
                    .setLookup(
                            Text.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("consecutiveWords", "explodedText", "generator", "unique")
                    .setStaticPropertyNames("baseText", "textStartsWithUppercase")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/ka_GE/Text.php")
