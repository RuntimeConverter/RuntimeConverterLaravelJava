...
public class ArrayCountToken extends RuntimeClassBase implements TokenInterface {
    ...
    public ArrayCountToken(NoConstructor n) {
        super(n);
    }
    ...
    public Object scoreArgument(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                ZVal.toBool(this.isCountable(env, argument))
                                && ZVal.toBool(this.hasProperCount(env, argument))
                        ? 6
                        : false);
    }
    ...
    public Object __toString(RuntimeEnv env, Object... args) {
        return ZVal.assign(function_sprintf.f.env(env).call("count(%s)", this.count).value());
    }
    ...
    private Object hasProperCount(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                ZVal.strictEqualityCheck(
                        this.count, "===", function_count.f.env(env).call(argument).value()));
    }
