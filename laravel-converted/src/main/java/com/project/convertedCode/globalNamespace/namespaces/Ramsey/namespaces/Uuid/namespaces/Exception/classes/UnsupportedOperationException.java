...
public class UnsupportedOperationException extends RuntimeException {
    ...
    public UnsupportedOperationException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnsupportedOperationException.class) {
            this.__construct(env, args);
        }
    }

    public UnsupportedOperationException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Ramsey\\Uuid\\Exception\\UnsupportedOperationException")
                    .setLookup(
