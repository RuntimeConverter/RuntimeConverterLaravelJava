...
public class ShiftLeft extends AssignOp {

    public ShiftLeft(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ShiftLeft.class) {
            this.__construct(env, args);
        }
    }

    public ShiftLeft(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\ShiftLeft";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\ShiftLeft")
                    .setLookup(
                            ShiftLeft.class,
