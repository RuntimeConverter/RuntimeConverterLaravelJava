...
public class greaterThanOrEqualTo extends FunctionBaseRegular {

    public static greaterThanOrEqualTo f = new greaterThanOrEqualTo();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "value")
    public Object call(RuntimeEnv env, Object... args) {
        Object value = assignParameter(args, 0, false);
        return ZVal.assign(OrderingComparison.runtimeStaticObject.greaterThanOrEqualTo(env, value));
    }
