...
public class Mod extends BinaryOp {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Mod";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Mod")
                    .setLookup(
                            Mod.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "left", "right")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/BinaryOp/Mod.php")
