...
public class Expression extends Stmt {
    ...
    public Expression(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Expression.class) {
            this.__construct(env, args);
        }
    }

    public Expression(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Expression";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Expression")
                    .setLookup(
                            Expression.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Expression.php")
