...
public class str_contains extends FunctionBaseRegular {

    public static str_contains f = new str_contains();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(Str.runtimeStaticObject.contains(env, haystack, needles));
    }
