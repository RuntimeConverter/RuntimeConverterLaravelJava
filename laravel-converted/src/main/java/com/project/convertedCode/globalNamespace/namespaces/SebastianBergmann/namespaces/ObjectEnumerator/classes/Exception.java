...
public interface Exception {
    ...
    public static final Object CONST_class = "SebastianBergmann\\ObjectEnumerator\\Exception";

    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("SebastianBergmann\\ObjectEnumerator\\Exception")
                    .setLookup(Exception.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/sebastian/object-enumerator/src/Exception.php")
                    .get();
}
