...
public class Trait_ extends ClassLike {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Trait_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Trait_")
                    .setLookup(
                            Trait_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Trait_.php")
