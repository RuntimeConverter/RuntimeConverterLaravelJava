...
public class PreconditionRequiredHttpException extends HttpException {

    public PreconditionRequiredHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PreconditionRequiredHttpException.class) {
            this.__construct(env, args);
        }
    }

    public PreconditionRequiredHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 428, message, previous, headers, code);
        return null;
    }
