...
public class Throw_ extends Stmt {

    public Object expr = null;

    public Throw_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Throw_.class) {
            this.__construct(env, args);
        }
    }

    public Throw_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Throw_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Throw_")
                    .setLookup(
                            Throw_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Throw_.php")
