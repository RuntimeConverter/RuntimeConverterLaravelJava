...
public class List_ extends Expr {

    public Object items = null;

    public List_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == List_.class) {
            this.__construct(env, args);
        }
    }

    public List_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\List_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\List_")
                    .setLookup(
                            List_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "items")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/List_.php")
