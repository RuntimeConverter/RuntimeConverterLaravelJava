...
public class NotAcceptableHttpException extends HttpException {
    ...
    public NotAcceptableHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NotAcceptableHttpException.class) {
            this.__construct(env, args);
        }
    }

    public NotAcceptableHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 406, message, previous, headers, code);
        return null;
    }
