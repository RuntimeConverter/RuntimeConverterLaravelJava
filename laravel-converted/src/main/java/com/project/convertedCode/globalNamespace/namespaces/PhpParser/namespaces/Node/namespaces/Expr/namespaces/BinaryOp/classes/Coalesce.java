...
public class Coalesce extends BinaryOp {

    public Coalesce(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Coalesce.class) {
            this.__construct(env, args);
        }
    }

    public Coalesce(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Coalesce";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Coalesce")
                    .setLookup(
                            Coalesce.class,
