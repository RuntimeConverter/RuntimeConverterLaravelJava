...
public class CommaInDomain extends InvalidEmail {

    public CommaInDomain(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == CommaInDomain.class) {
            this.__construct(env, args);
        }
    }

    public CommaInDomain(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 200;

    public static final Object CONST_REASON = "Comma ',' is not allowed in domain part";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\CommaInDomain";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\CommaInDomain")
                    .setLookup(
                            CommaInDomain.class,
