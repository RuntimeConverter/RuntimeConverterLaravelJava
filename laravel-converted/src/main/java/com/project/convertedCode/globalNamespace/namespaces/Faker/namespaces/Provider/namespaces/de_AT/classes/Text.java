...
public class Text
    ...
    public static final Object CONST_class = "Faker\\Provider\\de_AT\\Text";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\de_AT\\Text")
                    .setLookup(
                            Text.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("consecutiveWords", "explodedText", "generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/de_AT/Text.php")
                    .addExtendsClass("Faker\\Provider\\de_DE\\Text")
