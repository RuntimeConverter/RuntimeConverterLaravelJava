...
public class IniSizeFileException extends FileException {

    public IniSizeFileException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IniSizeFileException.class) {
            this.__construct(env, args);
        }
    }

    public IniSizeFileException(NoConstructor n) {
        super(n);
    }
