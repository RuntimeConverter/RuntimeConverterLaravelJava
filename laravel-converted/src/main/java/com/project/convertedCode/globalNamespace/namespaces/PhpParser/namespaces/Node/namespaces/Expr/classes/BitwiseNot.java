...
public class BitwiseNot extends Expr {

    public Object expr = null;

    public BitwiseNot(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BitwiseNot.class) {
            this.__construct(env, args);
        }
    }

    public BitwiseNot(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BitwiseNot";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BitwiseNot")
                    .setLookup(
                            BitwiseNot.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/BitwiseNot.php")
