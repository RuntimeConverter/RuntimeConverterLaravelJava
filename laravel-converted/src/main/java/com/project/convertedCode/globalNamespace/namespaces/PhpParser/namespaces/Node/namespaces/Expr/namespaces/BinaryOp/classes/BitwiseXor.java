...
public class BitwiseXor extends BinaryOp {

    public BitwiseXor(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BitwiseXor.class) {
            this.__construct(env, args);
        }
    }

    public BitwiseXor(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\BitwiseXor";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\BitwiseXor")
                    .setLookup(
                            BitwiseXor.class,
