...
public class Variable extends Expr {
    ...
    public Variable(RuntimeEnv env, Object... args) {
        super(env);
    ...
    public Variable(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Variable";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Variable")
                    .setLookup(
                            Variable.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Variable.php")
