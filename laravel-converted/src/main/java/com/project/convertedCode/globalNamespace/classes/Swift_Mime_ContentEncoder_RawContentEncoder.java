...
public class Swift_Mime_ContentEncoder_RawContentEncoder extends RuntimeClassBase
        implements Swift_Mime_ContentEncoder {

    public Swift_Mime_ContentEncoder_RawContentEncoder(RuntimeEnv env, Object... args) {
        super(env);
    }

    public Swift_Mime_ContentEncoder_RawContentEncoder(NoConstructor n) {
        super(n);
    }
        ...
        while (ZVal.strictNotEqualityCheck(
                ...
                bytes =
                        env.callMethod(
                                os,
                                "read",
                                Swift_Mime_ContentEncoder_RawContentEncoder.class,
                                8192))) {
            env.callMethod(is, "write", Swift_Mime_ContentEncoder_RawContentEncoder.class, bytes);
        }
    ...
    public static final Object CONST_class = "Swift_Mime_ContentEncoder_RawContentEncoder";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Swift_Mime_ContentEncoder_RawContentEncoder")
                    .setLookup(
                            Swift_Mime_ContentEncoder_RawContentEncoder.class,
