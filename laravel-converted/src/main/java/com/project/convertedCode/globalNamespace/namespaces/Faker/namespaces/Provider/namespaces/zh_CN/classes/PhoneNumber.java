...
public class PhoneNumber
    ...
    public static final Object CONST_class = "Faker\\Provider\\zh_CN\\PhoneNumber";
                ...
                ZVal.arrayFromLambdaExpression(
                        ...
                        () -> {
                            return ZVal.arrayFromList(
                                    ...
                                    1705, 178, 182, 183, 184, 187, 188, 130, 131, 132, 145, 155,
                                    156, 1707, 1708, 1709, 1718, 1719, 176, 185, 186, 133, 153,
                                    1700, 1701, 177, 180, 181, 189, 170, 171);
                        });
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\zh_CN\\PhoneNumber")
                    .setLookup(
                            PhoneNumber.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("formats", "operators")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/zh_CN/PhoneNumber.php")
