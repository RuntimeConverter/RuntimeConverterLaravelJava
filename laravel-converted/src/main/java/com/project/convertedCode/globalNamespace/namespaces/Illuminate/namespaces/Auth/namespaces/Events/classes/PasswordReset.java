...
public class PasswordReset extends RuntimeClassBase {

    public Object user = null;

    public PasswordReset(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PasswordReset.class) {
            this.__construct(env, args);
        }
    }

    public PasswordReset(NoConstructor n) {
        super(n);
    }
    ...
    public Object __sleep(RuntimeEnv env, Object... args) {
        ...
        properties =
                env.callMethod(
                        new ReflectionClass(env, this), "getProperties", PasswordReset.class);
        for (ZPair zpairResult2261 : ZVal.getIterable(properties, env, true)) {
            property = ZVal.assign(zpairResult2261.getValue());
            env.callMethod(
                    property,
                    "setValue",
                    PasswordReset.class,
    ...
    public Object __wakeup(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult2262 :
                ZVal.getIterable(
                        ...
                        env,
                        true)) {
            property = ZVal.assign(zpairResult2262.getValue());
            if (ZVal.isTrue(env.callMethod(property, "isStatic", PasswordReset.class))) {
                continue;
            }
    ...
    protected Object getPropertyValue(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(property, "setAccessible", PasswordReset.class, true);
        return ZVal.assign(env.callMethod(property, "getValue", PasswordReset.class, this));
    }
        ...
        if (ZVal.isTrue(ZVal.checkInstanceType(value, (Class) null, "QueueableCollection", env))) {
            return ZVal.assign(
                    env.createNew(
                            ...
                            env.callMethod(value, "getQueueableClass", PasswordReset.class),
                            env.callMethod(value, "getQueueableIds", PasswordReset.class),
                            env.callMethod(value, "getQueueableRelations", PasswordReset.class),
                            env.callMethod(value, "getQueueableConnection", PasswordReset.class)));
        }
        ...
        if (ZVal.isTrue(ZVal.checkInstanceType(value, (Class) null, "QueueableEntity", env))) {
            return ZVal.assign(
                    env.createNew(
                            ...
                            env.callMethod(value, "getQueueableId", PasswordReset.class),
                            env.callMethod(value, "getQueueableRelations", PasswordReset.class),
                            env.callMethod(value, "getQueueableConnection", PasswordReset.class)));
        }
    ...
    protected Object getQueryForModelRestoration(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                env.callMethod(model, "newQueryForRestoration", PasswordReset.class, ids));
    }

    public static final Object CONST_class = "Illuminate\\Auth\\Events\\PasswordReset";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Auth\\Events\\PasswordReset")
                    .setLookup(
                            PasswordReset.class,
