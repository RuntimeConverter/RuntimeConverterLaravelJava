...
public class Spaceship extends BinaryOp {

    public Spaceship(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Spaceship.class) {
            this.__construct(env, args);
        }
    }

    public Spaceship(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Spaceship";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Spaceship")
                    .setLookup(
                            Spaceship.class,
