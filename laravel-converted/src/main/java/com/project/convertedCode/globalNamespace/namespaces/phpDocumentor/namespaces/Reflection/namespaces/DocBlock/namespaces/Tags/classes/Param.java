...
public final class Param extends BaseTag implements StaticMethod {
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        Object isVariadic = assignParameter(args, 2, true);
        if (null == isVariadic) {
            isVariadic = false;
        }
    ...
    public Object __toString(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                toStringR(ZVal.isTrue(this.type) ? toStringR(this.type, env) + " " : "", env)
                        + toStringR(ZVal.isTrue(this.isVariadic(env)) ? "..." : "", env)
                        + "$"
        ...
        public Object create(RuntimeEnv env, Object... args) {
            ...
            if (ZVal.toBool(
                    ...
                    && ZVal.toBool(
                            ZVal.toBool(
                                            ZVal.strictEqualityCheck(
                                                    parts.arrayGet(env, 0, 0), "===", "$"))
                                    || ZVal.toBool(
                                            ZVal.strictEqualityCheck(
                                                    function_substr
                                                            .f
                                                            .env(env)
                                                            .call(parts.arrayGet(env, 0), 0, 4)
                                                            .value(),
                                                    "===",
                                                    "...$")))) {
                ...
                if (ZVal.strictEqualityCheck(
                        function_substr.f.env(env).call(variableName, 0, 3).value(),
                        "===",
                        "...")) {
                    isVariadic = true;
                    variableName = function_substr.f.env(env).call(variableName, 3).value();
                }
