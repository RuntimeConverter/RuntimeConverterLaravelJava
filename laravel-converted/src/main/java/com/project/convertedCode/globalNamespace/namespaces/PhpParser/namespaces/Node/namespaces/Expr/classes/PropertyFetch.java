...
public class PropertyFetch extends Expr {

    public Object var = null;

    public Object name = null;

    public PropertyFetch(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PropertyFetch.class) {
            this.__construct(env, args);
        }
    }

    public PropertyFetch(NoConstructor n) {
        super(n);
    }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("var", "name"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\PropertyFetch";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\PropertyFetch")
                    .setLookup(
                            PropertyFetch.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name", "var")
                    .setFilename(
                            "vendor/nikic/php-parser/lib/PhpParser/Node/Expr/PropertyFetch.php")
