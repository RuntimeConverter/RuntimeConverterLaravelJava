...
public class IsInteger extends IsTypeOf {

    public IsInteger(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IsInteger.class) {
            this.__construct(env, args);
        }
    }

    public IsInteger(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        super.__construct(env, "integer");
        return null;
    }

    public static final Object CONST_class = "Hamcrest\\Type\\IsInteger";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Hamcrest\\Type\\IsInteger")
                    .setLookup(
                            IsInteger.class,
