...
public interface AfterTestErrorHook extends TestHook {
    ...
    public Object executeAfterTestError(RuntimeEnv env, Object... args);

    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Runner\\AfterTestErrorHook")
                    .setLookup(AfterTestErrorHook.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/phpunit/phpunit/src/Runner/Hook/AfterTestErrorHook.php")
