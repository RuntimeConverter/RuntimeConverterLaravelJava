...
public class While_ extends Stmt {

    public Object cond = null;

    public Object stmts = null;

    public While_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == While_.class) {
            this.__construct(env, args);
        }
    }

    public While_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\While_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\While_")
                    .setLookup(
                            While_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "cond", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/While_.php")
