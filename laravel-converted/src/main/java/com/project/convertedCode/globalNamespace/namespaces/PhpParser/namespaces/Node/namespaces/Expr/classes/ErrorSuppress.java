...
public class ErrorSuppress extends Expr {

    public Object expr = null;

    public ErrorSuppress(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ErrorSuppress.class) {
            this.__construct(env, args);
        }
    }

    public ErrorSuppress(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\ErrorSuppress";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\ErrorSuppress")
                    .setLookup(
                            ErrorSuppress.class,
