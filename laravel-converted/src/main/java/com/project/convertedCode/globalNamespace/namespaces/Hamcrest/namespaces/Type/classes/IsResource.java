...
public class IsResource extends IsTypeOf {

    public IsResource(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IsResource.class) {
            this.__construct(env, args);
        }
    }

    public IsResource(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Hamcrest\\Type\\IsResource";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Hamcrest\\Type\\IsResource")
                    .setLookup(
                            IsResource.class,
