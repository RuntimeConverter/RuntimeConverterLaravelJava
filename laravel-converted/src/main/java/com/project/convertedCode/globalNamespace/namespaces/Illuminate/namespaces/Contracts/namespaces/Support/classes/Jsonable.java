...
public interface Jsonable {
    ...
    public static final Object CONST_class = "Illuminate\\Contracts\\Support\\Jsonable";
    ...
    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Contracts\\Support\\Jsonable")
                    .setLookup(Jsonable.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename(
                            "vendor/laravel/framework/src/Illuminate/Contracts/Support/Jsonable.php")
                    .get();
