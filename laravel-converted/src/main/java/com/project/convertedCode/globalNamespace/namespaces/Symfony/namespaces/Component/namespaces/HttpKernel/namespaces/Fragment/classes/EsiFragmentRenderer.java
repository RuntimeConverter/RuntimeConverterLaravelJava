...
public class EsiFragmentRenderer extends AbstractSurrogateFragmentRenderer {

    public EsiFragmentRenderer(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == EsiFragmentRenderer.class) {
            this.__construct(env, args);
        }
    }

    public EsiFragmentRenderer(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Fragment\\EsiFragmentRenderer")
                    .setLookup(
                            EsiFragmentRenderer.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("fragmentPath", "inlineStrategy", "signer", "surrogate")
                    .setFilename("vendor/symfony/http-kernel/Fragment/EsiFragmentRenderer.php")
                    .addInterface(
