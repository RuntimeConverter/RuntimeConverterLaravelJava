...
public class PreDec extends Expr {
    ...
    public PreDec(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PreDec.class) {
            this.__construct(env, args);
        }
    }

    public PreDec(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\PreDec";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\PreDec")
                    .setLookup(
                            PreDec.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/PreDec.php")
