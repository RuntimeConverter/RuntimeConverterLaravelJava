...
public class IsDouble extends IsTypeOf {

    public IsDouble(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IsDouble.class) {
            this.__construct(env, args);
        }
    }

    public IsDouble(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        super.__construct(env, "double");
        return null;
    }

    public static final Object CONST_class = "Hamcrest\\Type\\IsDouble";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Hamcrest\\Type\\IsDouble")
                    .setLookup(
                            IsDouble.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("_theType")
                    .setFilename("vendor/hamcrest/hamcrest-php/hamcrest/Hamcrest/Type/IsDouble.php")
