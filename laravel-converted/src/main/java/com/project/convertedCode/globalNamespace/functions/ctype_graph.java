...
public class ctype_graph extends FunctionBaseRegular {

    public static ctype_graph f = new ctype_graph();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_graph(env, text));
    }
