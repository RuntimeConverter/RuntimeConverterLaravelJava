...
public class IPV6DoubleColon extends Warning {
    ...
    public IPV6DoubleColon(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IPV6DoubleColon.class) {
            this.__construct(env, args);
        }
    }

    public IPV6DoubleColon(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this)
                .accessProp(this, env)
                .name("message")
                .set("Double colon found after IPV6 tag");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5322);
        return null;
    }

    public static final Object CONST_CODE = 73;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\IPV6DoubleColon";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\IPV6DoubleColon")
                    .setLookup(
                            IPV6DoubleColon.class,
