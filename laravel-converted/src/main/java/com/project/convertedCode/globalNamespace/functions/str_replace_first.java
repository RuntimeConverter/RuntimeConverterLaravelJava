...
public class str_replace_first extends FunctionBaseRegular {

    public static str_replace_first f = new str_replace_first();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(Str.runtimeStaticObject.replaceFirst(env, search, replace, subject));
    }
