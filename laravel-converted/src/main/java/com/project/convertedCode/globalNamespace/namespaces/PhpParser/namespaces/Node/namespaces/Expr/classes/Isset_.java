...
public class Isset_ extends Expr {

    public Object vars = null;

    public Isset_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Isset_.class) {
            this.__construct(env, args);
        }
    }

    public Isset_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Isset_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Isset_")
                    .setLookup(
                            Isset_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "vars")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Isset_.php")
