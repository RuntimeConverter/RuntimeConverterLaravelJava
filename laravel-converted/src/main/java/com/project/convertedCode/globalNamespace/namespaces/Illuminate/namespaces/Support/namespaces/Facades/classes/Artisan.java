...
public class Artisan extends Facade {

    public Artisan(RuntimeEnv env, Object... args) {
        super(env);
    }

    public Artisan(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Artisan";
    ...
    public static class RuntimeStaticCompanion extends Facade.RuntimeStaticCompanion {
        ...
        protected Object getFacadeAccessor(RuntimeEnv env, Object... args) {
            return ZVal.assign(Kernel.CONST_class);
        }
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Artisan")
                    .setLookup(
                            Artisan.class,
