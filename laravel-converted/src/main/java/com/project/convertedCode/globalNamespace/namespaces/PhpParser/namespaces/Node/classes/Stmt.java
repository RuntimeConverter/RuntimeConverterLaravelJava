...
public abstract class Stmt extends NodeAbstract {

    public Stmt(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Stmt.class) {
            this.__construct(env, args);
        }
    }

    public Stmt(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "PhpParser\\Node\\Stmt";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt")
                    .setLookup(
                            Stmt.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt.php")
