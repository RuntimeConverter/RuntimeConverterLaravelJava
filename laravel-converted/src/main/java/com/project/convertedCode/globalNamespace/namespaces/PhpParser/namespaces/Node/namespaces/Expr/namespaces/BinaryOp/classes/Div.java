...
public class Div extends BinaryOp {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Div";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Div")
                    .setLookup(
                            Div.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "left", "right")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/BinaryOp/Div.php")
