...
public class Label extends Stmt {
    ...
    public Label(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Label.class) {
            this.__construct(env, args);
        }
    }

    public Label(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Label";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Label")
                    .setLookup(
                            Label.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Label.php")
