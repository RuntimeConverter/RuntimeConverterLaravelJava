...
public class Const_ extends NodeAbstract {
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("name", "value"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Const_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Const_")
                    .setLookup(
                            Const_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name", "value")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Const_.php")
