...
public class AccessDeniedHttpException extends HttpException {

    public AccessDeniedHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AccessDeniedHttpException.class) {
            this.__construct(env, args);
        }
    }

    public AccessDeniedHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 403, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\AccessDeniedHttpException")
                    .setLookup(
