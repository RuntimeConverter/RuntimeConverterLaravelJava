...
public class Company
    ...
    public static final Object CONST_class = "Faker\\Provider\\de_AT\\Company";
    ...
    public static class RequestStaticProperties {
        ...
        public Object formats =
                ZVal.arrayFromList("{{lastName}} {{companySuffix}}", "{{lastName}}");

        public Object companySuffix =
                ZVal.arrayFromList(
                        "AG", "EWIV", "Ges.m.b.H.", "GmbH", "KEG", "KG", "OEG", "OG", "OHG", "SE");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\de_AT\\Company")
                    .setLookup(
                            Company.class,
                    ...
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/de_AT/Company.php")
