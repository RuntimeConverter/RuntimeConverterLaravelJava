...
public class Encapsed extends Scalar {

    public Object parts = null;

    public Encapsed(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Encapsed.class) {
            this.__construct(env, args);
        }
    }

    public Encapsed(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Scalar\\Encapsed";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Scalar\\Encapsed")
                    .setLookup(
                            Encapsed.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "parts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Scalar/Encapsed.php")
