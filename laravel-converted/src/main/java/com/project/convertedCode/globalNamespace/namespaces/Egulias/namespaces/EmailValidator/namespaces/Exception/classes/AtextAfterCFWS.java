...
public class AtextAfterCFWS extends InvalidEmail {
    ...
    public AtextAfterCFWS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AtextAfterCFWS.class) {
            this.__construct(env, args);
        }
    }

    public AtextAfterCFWS(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 133;

    public static final Object CONST_REASON = "ATEXT found after CFWS";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\AtextAfterCFWS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\AtextAfterCFWS")
                    .setLookup(
                            AtextAfterCFWS.class,
