...
public class TooManyRequestsHttpException extends HttpException {
    ...
    public TooManyRequestsHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == TooManyRequestsHttpException.class) {
            this.__construct(env, args);
        }
    }

    public TooManyRequestsHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 429, message, previous, headers.getObject(), code);
        return null;
    }
