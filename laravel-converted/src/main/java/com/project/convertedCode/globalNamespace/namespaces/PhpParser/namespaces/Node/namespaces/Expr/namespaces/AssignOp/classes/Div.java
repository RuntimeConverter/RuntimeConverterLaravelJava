...
public class Div extends AssignOp {

    public Div(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Div.class) {
            this.__construct(env, args);
        }
    }

    public Div(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\Div";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\Div")
                    .setLookup(
                            Div.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/AssignOp/Div.php")
