...
public class ConflictHttpException extends HttpException {
    ...
    public ConflictHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ConflictHttpException.class) {
            this.__construct(env, args);
        }
    }

    public ConflictHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 409, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\ConflictHttpException")
                    .setLookup(
                            ConflictHttpException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("headers", "statusCode")
                    .setFilename("vendor/symfony/http-kernel/Exception/ConflictHttpException.php")
                    .addInterface(
