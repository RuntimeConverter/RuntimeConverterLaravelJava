...
public interface AfterSkippedTestHook extends TestHook {
    ...
    public Object executeAfterSkippedTest(RuntimeEnv env, Object... args);

    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Runner\\AfterSkippedTestHook")
                    .setLookup(AfterSkippedTestHook.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/phpunit/phpunit/src/Runner/Hook/AfterSkippedTestHook.php")
