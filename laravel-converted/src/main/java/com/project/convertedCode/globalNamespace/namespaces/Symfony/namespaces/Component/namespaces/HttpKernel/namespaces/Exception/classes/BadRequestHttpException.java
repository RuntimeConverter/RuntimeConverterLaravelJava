...
public class BadRequestHttpException extends HttpException {
    ...
    public BadRequestHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BadRequestHttpException.class) {
            this.__construct(env, args);
        }
    }

    public BadRequestHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 400, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\BadRequestHttpException")
                    .setLookup(
                            BadRequestHttpException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("headers", "statusCode")
                    .setFilename("vendor/symfony/http-kernel/Exception/BadRequestHttpException.php")
                    .addInterface(
