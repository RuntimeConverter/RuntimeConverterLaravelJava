...
public class ObjectMethodsMatcher extends AbstractContextAwareMatcher {

    public ObjectMethodsMatcher(RuntimeEnv env, Object... args) {
        super(env);
    }

    public ObjectMethodsMatcher(NoConstructor n) {
        super(n);
    }
    ...
    public Object getMatches(RuntimeEnv env, Object... args) {
        ...
        Object _object = null;
        input = env.callMethod(this, "getInput", ObjectMethodsMatcher.class, tokens);
        ...
        try {
            _object = env.callMethod(this, "getVariable", ObjectMethodsMatcher.class, objectName);
        } catch (ConvertedException convertedException207) {
            if (convertedException207.instanceOf(
                    InvalidArgumentException.class, "InvalidArgumentException")) {
                e = convertedException207.getObject();
                return ZVal.assign(ZVal.newArray());
            } else {
                throw convertedException207;
            }
        }
        ...
        return ZVal.assign(
                function_array_filter
                        ...
                        .env(env)
                        .call(
                                NamespaceGlobal.get_class_methods.env(env).call(_object).value(),
                                new Closure(
                                        env,
    ...
    public Object hasMatched(RuntimeEnv env, Object... args) {
        ...
        SwitchEnumType90 switchVariable90 =
                ZVal.getEnum(
                        true,
                        SwitchEnumType90.DEFAULT_CASE,
                        SwitchEnumType90.DYNAMIC_TYPE_323,
                        runtimeStaticObject.tokenIs(env, token, CONST_T_OBJECT_OPERATOR),
                        SwitchEnumType90.DYNAMIC_TYPE_324,
                        runtimeStaticObject.tokenIs(env, prevToken, CONST_T_OBJECT_OPERATOR));
        switch (switchVariable90) {
            case DYNAMIC_TYPE_323:
            case DYNAMIC_TYPE_324:
    ...
    public static final Object CONST_class = "Psy\\TabCompletion\\Matcher\\ObjectMethodsMatcher";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Psy\\TabCompletion\\Matcher\\ObjectMethodsMatcher")
                    .setLookup(
