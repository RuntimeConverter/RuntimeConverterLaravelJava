...
public class CannotWriteFileException extends FileException {
    ...
    public CannotWriteFileException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == CannotWriteFileException.class) {
            this.__construct(env, args);
        }
    }

    public CannotWriteFileException(NoConstructor n) {
        super(n);
    }
