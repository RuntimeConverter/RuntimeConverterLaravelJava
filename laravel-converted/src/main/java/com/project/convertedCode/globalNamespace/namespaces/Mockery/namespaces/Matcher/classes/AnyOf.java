...
public class AnyOf extends MatcherAbstract {
    ...
    public static final Object CONST_class = "Mockery\\Matcher\\AnyOf";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Mockery\\Matcher\\AnyOf")
                    .setLookup(
                            AnyOf.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("_expected")
                    .setFilename("vendor/mockery/mockery/library/Mockery/Matcher/AnyOf.php")
