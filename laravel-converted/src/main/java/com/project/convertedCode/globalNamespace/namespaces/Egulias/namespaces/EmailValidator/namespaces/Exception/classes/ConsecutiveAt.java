...
public class ConsecutiveAt extends InvalidEmail {
    ...
    public ConsecutiveAt(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ConsecutiveAt.class) {
            this.__construct(env, args);
        }
    }

    public ConsecutiveAt(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 128;

    public static final Object CONST_REASON = "Consecutive AT";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\ConsecutiveAt";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\ConsecutiveAt")
                    .setLookup(
                            ConsecutiveAt.class,
