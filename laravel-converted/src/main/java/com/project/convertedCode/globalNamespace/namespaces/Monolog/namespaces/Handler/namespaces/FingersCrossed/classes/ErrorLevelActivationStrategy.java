...
public class ErrorLevelActivationStrategy extends RuntimeClassBase
        implements ActivationStrategyInterface {

    public Object actionLevel = null;

    public ErrorLevelActivationStrategy(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ErrorLevelActivationStrategy.class) {
            this.__construct(env, args);
        }
    }

    public ErrorLevelActivationStrategy(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "actionLevel")
    public Object __construct(RuntimeEnv env, Object... args) {
        Object actionLevel = assignParameter(args, 0, false);
        this.actionLevel = Logger.runtimeStaticObject.toMonologLevel(env, actionLevel);
        return null;
    }
    ...
    public Object isHandlerActivated(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                ZVal.isGreaterThanOrEqualTo(record.arrayGet(env, "level"), ">=", this.actionLevel));
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Monolog\\Handler\\FingersCrossed\\ErrorLevelActivationStrategy")
                    .setLookup(
                            ErrorLevelActivationStrategy.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("actionLevel")
                    .setFilename(
                            "vendor/monolog/monolog/src/Monolog/Handler/FingersCrossed/ErrorLevelActivationStrategy.php")
