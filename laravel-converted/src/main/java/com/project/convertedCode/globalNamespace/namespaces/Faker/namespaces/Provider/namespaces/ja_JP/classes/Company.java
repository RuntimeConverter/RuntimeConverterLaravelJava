...
public class Company
    ...
    public static final Object CONST_class = "Faker\\Provider\\ja_JP\\Company";
    ...
    public static class RequestStaticProperties {
        ...
        public Object formats = ZVal.arrayFromList("{{companyPrefix}} {{lastName}}");

        public Object companyPrefix =
                ZVal.arrayFromList("\u682A\u5F0F\u4F1A\u793E", "\u6709\u9650\u4F1A\u793E");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\ja_JP\\Company")
                    .setLookup(
                            Company.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("companyPrefix", "formats")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/ja_JP/Company.php")
