...
public class ElementParser extends RuntimeClassBase implements ParserInterface {

    public ElementParser(RuntimeEnv env, Object... args) {
        super(env);
    }

    public ElementParser(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\CssSelector\\Parser\\Shortcut\\ElementParser")
                    .setLookup(
                            ElementParser.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/css-selector/Parser/Shortcut/ElementParser.php")
