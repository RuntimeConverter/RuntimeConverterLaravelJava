...
public interface Highlighter {
    ...
    public static final Object CONST_class = "NunoMaduro\\Collision\\Contracts\\Highlighter";
    ...
    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("NunoMaduro\\Collision\\Contracts\\Highlighter")
                    .setLookup(Highlighter.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/nunomaduro/collision/src/Contracts/Highlighter.php")
                    .get();
}
