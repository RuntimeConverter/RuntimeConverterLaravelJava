...
public class ctype_digit extends FunctionBaseRegular {

    public static ctype_digit f = new ctype_digit();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_digit(env, text));
    }
