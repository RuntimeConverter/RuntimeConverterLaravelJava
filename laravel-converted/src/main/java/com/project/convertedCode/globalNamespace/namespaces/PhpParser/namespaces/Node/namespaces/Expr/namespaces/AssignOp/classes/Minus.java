...
public class Minus extends AssignOp {

    public Minus(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Minus.class) {
            this.__construct(env, args);
        }
    }

    public Minus(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\Minus";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\Minus")
                    .setLookup(
                            Minus.class,
