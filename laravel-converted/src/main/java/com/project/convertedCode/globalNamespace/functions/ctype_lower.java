...
public class ctype_lower extends FunctionBaseRegular {

    public static ctype_lower f = new ctype_lower();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_lower(env, text));
    }
