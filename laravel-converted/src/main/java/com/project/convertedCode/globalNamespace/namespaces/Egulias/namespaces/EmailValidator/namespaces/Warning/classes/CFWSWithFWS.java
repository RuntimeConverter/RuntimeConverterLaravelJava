...
public class CFWSWithFWS extends Warning {
    ...
    public CFWSWithFWS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == CFWSWithFWS.class) {
            this.__construct(env, args);
        }
    }

    public CFWSWithFWS(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this)
                .accessProp(this, env)
                .name("message")
                .set("Folding whites space followed by folding white space");
        return null;
    }

    public static final Object CONST_CODE = 18;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\CFWSWithFWS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\CFWSWithFWS")
                    .setLookup(
                            CFWSWithFWS.class,
