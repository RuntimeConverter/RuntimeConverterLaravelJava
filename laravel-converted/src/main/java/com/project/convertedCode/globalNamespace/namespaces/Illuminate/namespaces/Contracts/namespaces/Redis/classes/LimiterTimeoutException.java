...
public class LimiterTimeoutException extends PHPException {

    public LimiterTimeoutException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == LimiterTimeoutException.class) {
            this.__construct(env, args);
        }
    }

    public LimiterTimeoutException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Contracts\\Redis\\LimiterTimeoutException")
                    .setLookup(
