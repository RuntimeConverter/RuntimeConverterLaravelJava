...
public class DummyTest extends RuntimeClassBase {

    public DummyTest(RuntimeEnv env, Object... args) {
        super(env);
    }

    public DummyTest(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Psr\\Log\\Test\\DummyTest";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Psr\\Log\\Test\\DummyTest")
                    .setLookup(
                            DummyTest.class,
