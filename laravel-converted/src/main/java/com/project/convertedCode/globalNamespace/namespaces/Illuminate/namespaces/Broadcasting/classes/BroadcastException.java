...
public class BroadcastException extends RuntimeException {
    ...
    public BroadcastException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BroadcastException.class) {
            this.__construct(env, args);
        }
    }

    public BroadcastException(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Broadcasting\\BroadcastException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Broadcasting\\BroadcastException")
                    .setLookup(
