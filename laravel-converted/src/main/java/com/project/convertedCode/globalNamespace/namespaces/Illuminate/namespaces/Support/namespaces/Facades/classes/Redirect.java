...
public class Redirect extends Facade {

    public Redirect(RuntimeEnv env, Object... args) {
        super(env);
    }

    public Redirect(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Redirect";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Redirect")
                    .setLookup(
                            Redirect.class,
