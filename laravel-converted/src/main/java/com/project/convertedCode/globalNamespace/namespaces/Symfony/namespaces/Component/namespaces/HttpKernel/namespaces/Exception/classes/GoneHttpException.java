...
public class GoneHttpException extends HttpException {
    ...
    public GoneHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == GoneHttpException.class) {
            this.__construct(env, args);
        }
    }

    public GoneHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 410, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\GoneHttpException")
                    .setLookup(
                            GoneHttpException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("headers", "statusCode")
                    .setFilename("vendor/symfony/http-kernel/Exception/GoneHttpException.php")
                    .addInterface(
