...
public class Swift_DependencyException extends Swift_SwiftException {

    public Swift_DependencyException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Swift_DependencyException.class) {
            this.__construct(env, args);
        }
    }

    public Swift_DependencyException(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Swift_DependencyException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Swift_DependencyException")
                    .setLookup(
