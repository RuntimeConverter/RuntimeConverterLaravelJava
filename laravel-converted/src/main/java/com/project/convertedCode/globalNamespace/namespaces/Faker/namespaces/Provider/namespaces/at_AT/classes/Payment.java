package com.project.convertedCode.globalNamespace.namespaces.Faker.namespaces.Provider.namespaces.at_AT.classes;
...
public class Payment
    ...
    public static final Object CONST_class = "Faker\\Provider\\at_AT\\Payment";
    ...
    public static class RuntimeStaticCompanion
        ...
        public Object vat(RuntimeEnv env, Object... args) {
            ...
            Object prefix = null;
            prefix = ZVal.assign(ZVal.isTrue(spacedNationalPrefix) ? "AT U" : "ATU");
            return ZVal.assign(
                    function_sprintf
                            .f
                            .env(env)
                            .call("%s%d", prefix, runtimeStaticObject.randomNumber(env, 8, true))
                            .value());
        }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\at_AT\\Payment")
                    .setLookup(
                            Payment.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/at_AT/Payment.php")
