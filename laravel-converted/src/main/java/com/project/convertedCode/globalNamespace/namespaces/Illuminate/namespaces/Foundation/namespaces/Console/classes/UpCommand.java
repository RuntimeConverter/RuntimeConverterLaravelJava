...
public class UpCommand extends Command {
    ...
    public UpCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "up";
        this.description = "Bring the application out of maintenance mode";
        if (this.getClass() == UpCommand.class) {
            this.__construct(env, args);
        }
    }

    public UpCommand(NoConstructor n) {
        super(n);
    }
    ...
    public Object handle(RuntimeEnv env, Object... args) {
        NamespaceGlobal.unlink
                .env(env)
                .call(storage_path.f.env(env).call("framework/down").value())
                .value();
        env.callMethod(this, "info", UpCommand.class, "Application is now live.");
        return null;
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\UpCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\UpCommand")
                    .setLookup(
                            UpCommand.class,
