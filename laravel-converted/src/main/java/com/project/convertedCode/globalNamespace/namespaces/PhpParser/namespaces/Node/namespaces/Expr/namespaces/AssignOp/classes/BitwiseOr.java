...
public class BitwiseOr extends AssignOp {

    public BitwiseOr(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BitwiseOr.class) {
            this.__construct(env, args);
        }
    }

    public BitwiseOr(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\BitwiseOr";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\BitwiseOr")
                    .setLookup(
                            BitwiseOr.class,
