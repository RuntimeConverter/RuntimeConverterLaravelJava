...
public class NotFoundResourceException extends InvalidArgumentException
        implements ExceptionInterface {

    public NotFoundResourceException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NotFoundResourceException.class) {
            this.__construct(env, args);
        }
    }

    public NotFoundResourceException(NoConstructor n) {
        super(n);
    }
