...
public interface Exception {
    ...
    public static final Object CONST_class = "SebastianBergmann\\Diff\\Exception";

    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("SebastianBergmann\\Diff\\Exception")
                    .setLookup(Exception.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/sebastian/diff/src/Exception/Exception.php")
                    .get();
}
