...
public class ShellExec extends Expr {

    public Object parts = null;

    public ShellExec(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ShellExec.class) {
            this.__construct(env, args);
        }
    }

    public ShellExec(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\ShellExec";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\ShellExec")
                    .setLookup(
                            ShellExec.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "parts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/ShellExec.php")
