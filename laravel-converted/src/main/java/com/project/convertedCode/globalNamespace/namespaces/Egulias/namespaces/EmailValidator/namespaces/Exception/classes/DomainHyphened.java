...
public class DomainHyphened extends InvalidEmail {

    public DomainHyphened(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == DomainHyphened.class) {
            this.__construct(env, args);
        }
    }

    public DomainHyphened(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 144;

    public static final Object CONST_REASON = "Hyphen found in domain";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\DomainHyphened";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\DomainHyphened")
                    .setLookup(
                            DomainHyphened.class,
