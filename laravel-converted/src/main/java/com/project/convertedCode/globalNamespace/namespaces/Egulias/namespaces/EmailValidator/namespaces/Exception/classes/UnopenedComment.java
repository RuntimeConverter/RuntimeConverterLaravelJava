...
public class UnopenedComment extends InvalidEmail {

    public UnopenedComment(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnopenedComment.class) {
            this.__construct(env, args);
        }
    }

    public UnopenedComment(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 152;

    public static final Object CONST_REASON = "No opening comment token found";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\UnopenedComment";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\UnopenedComment")
                    .setLookup(
                            UnopenedComment.class,
