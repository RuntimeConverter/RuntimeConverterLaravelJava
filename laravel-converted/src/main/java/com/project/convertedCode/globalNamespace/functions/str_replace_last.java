...
public class str_replace_last extends FunctionBaseRegular {

    public static str_replace_last f = new str_replace_last();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(Str.runtimeStaticObject.replaceLast(env, search, replace, subject));
    }
