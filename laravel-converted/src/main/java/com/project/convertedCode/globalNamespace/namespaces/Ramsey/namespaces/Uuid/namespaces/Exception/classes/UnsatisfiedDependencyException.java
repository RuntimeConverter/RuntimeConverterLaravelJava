...
public class UnsatisfiedDependencyException extends RuntimeException {
    ...
    public UnsatisfiedDependencyException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnsatisfiedDependencyException.class) {
            this.__construct(env, args);
        }
    }

    public UnsatisfiedDependencyException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Ramsey\\Uuid\\Exception\\UnsatisfiedDependencyException")
                    .setLookup(
