...
public class IPV6GroupCount extends Warning {
    ...
    public IPV6GroupCount(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IPV6GroupCount.class) {
            this.__construct(env, args);
        }
    }

    public IPV6GroupCount(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("Group count is not IPV6 valid");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5322);
        return null;
    }

    public static final Object CONST_CODE = 72;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\IPV6GroupCount";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\IPV6GroupCount")
                    .setLookup(
                            IPV6GroupCount.class,
