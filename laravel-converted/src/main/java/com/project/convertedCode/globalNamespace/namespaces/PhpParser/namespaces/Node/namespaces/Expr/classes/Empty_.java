...
public class Empty_ extends Expr {

    public Object expr = null;

    public Empty_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Empty_.class) {
            this.__construct(env, args);
        }
    }

    public Empty_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Empty_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Empty_")
                    .setLookup(
                            Empty_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Empty_.php")
