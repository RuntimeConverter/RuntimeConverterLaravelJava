...
public class PostDec extends Expr {
    ...
    public PostDec(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PostDec.class) {
            this.__construct(env, args);
        }
    }

    public PostDec(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\PostDec";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\PostDec")
                    .setLookup(
                            PostDec.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/PostDec.php")
