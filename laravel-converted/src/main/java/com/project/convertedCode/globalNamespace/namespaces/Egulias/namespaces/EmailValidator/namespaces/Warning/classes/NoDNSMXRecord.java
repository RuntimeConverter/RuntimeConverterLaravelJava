...
public class NoDNSMXRecord extends Warning {
    ...
    public NoDNSMXRecord(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NoDNSMXRecord.class) {
            this.__construct(env, args);
        }
    }

    public NoDNSMXRecord(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this)
                .accessProp(this, env)
                .name("message")
                .set("No MX DSN record was found for this email");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5321);
        return null;
    }

    public static final Object CONST_CODE = 6;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\NoDNSMXRecord";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\NoDNSMXRecord")
                    .setLookup(
                            NoDNSMXRecord.class,
