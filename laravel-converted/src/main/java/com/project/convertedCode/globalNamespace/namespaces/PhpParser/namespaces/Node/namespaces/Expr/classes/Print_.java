...
public class Print_ extends Expr {

    public Object expr = null;

    public Print_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Print_.class) {
            this.__construct(env, args);
        }
    }

    public Print_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Print_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Print_")
                    .setLookup(
                            Print_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Print_.php")
