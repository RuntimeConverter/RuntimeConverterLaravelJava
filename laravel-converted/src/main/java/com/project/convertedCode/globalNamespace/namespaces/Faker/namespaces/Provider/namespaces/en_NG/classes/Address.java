...
public class Address
    ...
    public static final Object CONST_class = "Faker\\Provider\\en_NG\\Address";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\en_NG\\Address")
                    .setLookup(
                            Address.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("country", "county", "postcode", "regions")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/en_NG/Address.php")
