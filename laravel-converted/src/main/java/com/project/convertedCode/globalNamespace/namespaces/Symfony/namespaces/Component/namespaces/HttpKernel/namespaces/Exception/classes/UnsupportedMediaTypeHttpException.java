...
public class UnsupportedMediaTypeHttpException extends HttpException {
    ...
    public UnsupportedMediaTypeHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnsupportedMediaTypeHttpException.class) {
            this.__construct(env, args);
        }
    }

    public UnsupportedMediaTypeHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 415, message, previous, headers, code);
        return null;
    }
