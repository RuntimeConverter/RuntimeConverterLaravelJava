...
public class StringContainsToken extends RuntimeClassBase implements TokenInterface {
    ...
    public StringContainsToken(NoConstructor n) {
        super(n);
    }
    ...
    public Object scoreArgument(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                ZVal.strictNotEqualityCheck(
                                function_strpos.f.env(env).call(argument, this.value).value(),
                                "!==",
                                false)
                        ? 6
                        : false);
    ...
    public Object __toString(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                function_sprintf.f.env(env).call("contains(\"%s\")", this.value).value());
    }
