...
public class Mul extends AssignOp {

    public Mul(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Mul.class) {
            this.__construct(env, args);
        }
    }

    public Mul(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\Mul";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\Mul")
                    .setLookup(
                            Mul.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/AssignOp/Mul.php")
