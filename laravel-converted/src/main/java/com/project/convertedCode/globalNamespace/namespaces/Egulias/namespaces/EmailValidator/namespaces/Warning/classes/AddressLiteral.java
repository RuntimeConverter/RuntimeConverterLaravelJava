...
public class AddressLiteral extends Warning {
    ...
    public AddressLiteral(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AddressLiteral.class) {
            this.__construct(env, args);
        }
    }

    public AddressLiteral(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("Address literal in domain part");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5321);
        return null;
    }

    public static final Object CONST_CODE = 12;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\AddressLiteral";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\AddressLiteral")
                    .setLookup(
