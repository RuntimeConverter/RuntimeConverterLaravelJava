...
public class Payment
    ...
    public static final Object CONST_class = "Faker\\Provider\\bg_BG\\Payment";
    ...
    public static class RuntimeStaticCompanion
        ...
        public Object vat(RuntimeEnv env, Object... args) {
            ...
            Object prefix = null;
            prefix = ZVal.assign(ZVal.isTrue(spacedNationalPrefix) ? "BG " : "BG");
            return ZVal.assign(
                    function_sprintf
                            .f
                            .env(env)
                            .call(
                                    "%s%d%d",
                                    prefix,
                                    runtimeStaticObject.randomNumber(env, 5, true),
                                    runtimeStaticObject.randomNumber(
                                            env,
                                            runtimeStaticObject.randomElement(
                                                    env, ZVal.arrayFromList(4, 5)),
                                            true))
                            .value());
        }
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\bg_BG\\Payment")
                    .setLookup(
                            Payment.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/bg_BG/Payment.php")
