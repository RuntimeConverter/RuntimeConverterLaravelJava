...
public class Bool_ extends Cast {

    public Bool_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Bool_.class) {
            this.__construct(env, args);
        }
    }

    public Bool_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Cast\\Bool_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Cast\\Bool_")
                    .setLookup(
                            Bool_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Bool_.php")
