...
public class MySqlProcessor extends Processor {
    ...
    public MySqlProcessor(RuntimeEnv env, Object... args) {
        super(env);
    }

    public MySqlProcessor(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Database\\Query\\Processors\\MySqlProcessor")
                    .setLookup(
                            MySqlProcessor.class,
