...
public class StringContainsIgnoringCase extends SubstringMatcher {
    ...
    public StringContainsIgnoringCase(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == StringContainsIgnoringCase.class) {
            this.__construct(env, args);
        }
    }

    public StringContainsIgnoringCase(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Hamcrest\\Text\\StringContainsIgnoringCase";
        ...
        public Object containsStringIgnoringCase(RuntimeEnv env, Object... args) {
            ...
            return ZVal.assign(
                    new com.project
                            ...
                            .Text
                            .classes
                            .StringContainsIgnoringCase(env, substring));
        }
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Hamcrest\\Text\\StringContainsIgnoringCase")
                    .setLookup(
                            StringContainsIgnoringCase.class,
