...
public class Clone_ extends Expr {

    public Object expr = null;

    public Clone_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Clone_.class) {
            this.__construct(env, args);
        }
    }

    public Clone_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Clone_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Clone_")
                    .setLookup(
                            Clone_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Clone_.php")
