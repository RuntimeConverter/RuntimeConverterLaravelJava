...
public class Blade extends Facade {

    public Blade(RuntimeEnv env, Object... args) {
        super(env);
    }

    public Blade(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Blade";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Blade")
                    .setLookup(
                            Blade.class,
