...
public class YieldFrom extends Expr {
    ...
    public YieldFrom(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == YieldFrom.class) {
            this.__construct(env, args);
        }
    }

    public YieldFrom(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\YieldFrom";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\YieldFrom")
                    .setLookup(
                            YieldFrom.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/YieldFrom.php")
