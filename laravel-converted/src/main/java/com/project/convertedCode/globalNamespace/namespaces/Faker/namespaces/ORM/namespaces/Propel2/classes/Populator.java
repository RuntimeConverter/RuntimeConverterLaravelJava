...
import com.project.convertedCode.globalNamespace.namespaces.Faker.namespaces.ORM.namespaces.Propel2.classes.EntityPopulator;
...
public class Populator extends RuntimeClassBase {
    ...
    public Object addEntity(RuntimeEnv env, Object... args) {
        ...
        if (!ZVal.isTrue(
                ZVal.checkInstanceType(
                        entity, EntityPopulator.class, "Faker\\ORM\\Propel2\\EntityPopulator"))) {
    ...
    public Object execute(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult99 : ZVal.getIterable(this.quantities, env, false)) {
            _pClass = ZVal.assign(zpairResult99.getKey());
            number = ZVal.assign(zpairResult99.getValue());
            for (i.setObject(0);
    ...
    protected Object getConnection(RuntimeEnv env, Object... args) {
        ...
        peer = ZVal.assign(ClassConstantUtils.getConstantValueByClass(env, _pClass, "TABLE_MAP"));
        return ZVal.assign(
                StaticMethodUtils.getStaticBaseClass(ZVal.resolveClassAlias(env, "Propel"), env)
                        .callUnknownStaticMethod(
                                ...
                                ClassConstantUtils.getConstantValueByClass(
                                        env,
                                        ZVal.resolveClassAlias(env, "ServiceContainerInterface"),
                                        "CONNECTION_WRITE")));
    }

    public static final Object CONST_class = "Faker\\ORM\\Propel2\\Populator";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\ORM\\Propel2\\Populator")
                    .setLookup(
                            Populator.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("entities", "generator", "quantities")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/ORM/Propel2/Populator.php")
                    .get();
