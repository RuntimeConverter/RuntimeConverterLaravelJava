...
public class LogicalXor extends Constraint {
    ...
    public LogicalXor(NoConstructor n) {
        super(n);
    }
    ...
    public Object setConstraints(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult1130 : ZVal.getIterable(constraints, env, true)) {
            constraint = ZVal.assign(zpairResult1130.getValue());
            if (!ZVal.isTrue(
    ...
    public Object evaluate(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult1131 : ZVal.getIterable(this.constraints, env, true)) {
            constraint = ZVal.assign(zpairResult1131.getValue());
            result =
                    env.callMethod(
    ...
    public Object toString(RuntimeEnv env, Object... args) {
        ...
        Object key = null;
        text = "";
        for (ZPair zpairResult1132 : ZVal.getIterable(this.constraints, env, false)) {
            key = ZVal.assign(zpairResult1132.getKey());
            constraint = ZVal.assign(zpairResult1132.getValue());
    ...
    public Object count(RuntimeEnv env, Object... args) {
        ...
        Object constraint = null;
        count = 0;
        for (ZPair zpairResult1133 : ZVal.getIterable(this.constraints, env, true)) {
            constraint = ZVal.assign(zpairResult1133.getValue());
            count =
                    ZAssignment.add(
