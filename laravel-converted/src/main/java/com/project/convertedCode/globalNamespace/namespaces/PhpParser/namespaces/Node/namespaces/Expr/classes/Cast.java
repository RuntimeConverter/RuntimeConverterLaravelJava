...
public abstract class Cast extends Expr {
    ...
    public Cast(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Cast.class) {
            this.__construct(env, args);
        }
    }

    public Cast(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Cast";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Cast")
                    .setLookup(
                            Cast.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Cast.php")
