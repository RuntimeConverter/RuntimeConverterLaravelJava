...
public class Pow extends BinaryOp {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Pow";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Pow")
                    .setLookup(
                            Pow.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "left", "right")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/BinaryOp/Pow.php")
