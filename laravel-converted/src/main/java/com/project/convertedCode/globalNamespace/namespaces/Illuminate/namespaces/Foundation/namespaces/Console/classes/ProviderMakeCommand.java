...
public class ProviderMakeCommand extends GeneratorCommand {

    public ProviderMakeCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "make:provider";
        this.description = "Create a new service provider class";
        this.type = "Provider";
        if (this.getClass() == ProviderMakeCommand.class) {
            this.__construct(env, args);
        }
    }

    public ProviderMakeCommand(NoConstructor n) {
        super(n);
    }
    ...
    protected Object getDefaultNamespace(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(toStringR(rootNamespace, env) + "\\Providers");
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\ProviderMakeCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\ProviderMakeCommand")
                    .setLookup(
