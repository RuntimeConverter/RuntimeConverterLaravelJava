...
public class ParseException extends PHPException implements ExceptionInterface {

    public ParseException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ParseException.class) {
            this.__construct(env, args);
        }
    }

    public ParseException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\CssSelector\\Exception\\ParseException")
                    .setLookup(
                            ParseException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/css-selector/Exception/ParseException.php")
