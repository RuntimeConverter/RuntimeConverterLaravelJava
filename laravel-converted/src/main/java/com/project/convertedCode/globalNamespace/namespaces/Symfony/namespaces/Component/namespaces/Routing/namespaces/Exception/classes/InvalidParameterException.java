...
public class InvalidParameterException extends InvalidArgumentException
        implements ExceptionInterface {

    public InvalidParameterException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == InvalidParameterException.class) {
            this.__construct(env, args);
        }
    }

    public InvalidParameterException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\Routing\\Exception\\InvalidParameterException")
                    .setLookup(
                            InvalidParameterException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/routing/Exception/InvalidParameterException.php")
