...
public class Not extends MatcherAbstract {

    public Not(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Not.class) {
            this.__construct(env, args);
        }
    }

    public Not(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Mockery\\Matcher\\Not";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Mockery\\Matcher\\Not")
                    .setLookup(
                            Not.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("_expected")
                    .setFilename("vendor/mockery/mockery/library/Mockery/Matcher/Not.php")
