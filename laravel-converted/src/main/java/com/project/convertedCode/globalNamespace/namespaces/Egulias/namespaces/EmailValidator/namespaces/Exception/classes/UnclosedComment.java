...
public class UnclosedComment extends InvalidEmail {
    ...
    public UnclosedComment(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnclosedComment.class) {
            this.__construct(env, args);
        }
    }

    public UnclosedComment(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 146;

    public static final Object CONST_REASON = "No colosing comment token found";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\UnclosedComment";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\UnclosedComment")
                    .setLookup(
                            UnclosedComment.class,
