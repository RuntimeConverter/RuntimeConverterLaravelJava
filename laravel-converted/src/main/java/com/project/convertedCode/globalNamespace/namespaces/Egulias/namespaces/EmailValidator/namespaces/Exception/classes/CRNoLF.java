...
public class CRNoLF extends InvalidEmail {

    public CRNoLF(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == CRNoLF.class) {
            this.__construct(env, args);
        }
    }

    public CRNoLF(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 150;

    public static final Object CONST_REASON = "Missing LF after CR";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\CRNoLF";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\CRNoLF")
                    .setLookup(
                            CRNoLF.class,
