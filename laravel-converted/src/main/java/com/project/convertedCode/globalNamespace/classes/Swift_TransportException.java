...
public class Swift_TransportException extends Swift_IoException {

    public Swift_TransportException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Swift_TransportException.class) {
            this.__construct(env, args);
        }
    }

    public Swift_TransportException(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Swift_TransportException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Swift_TransportException")
                    .setLookup(
