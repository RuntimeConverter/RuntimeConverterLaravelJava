...
public class Declare_ extends Stmt {

    public Object declares = null;

    public Object stmts = null;

    public Declare_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Declare_.class) {
            this.__construct(env, args);
        }
    }

    public Declare_(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "declares", typeHint = "array")
    @ConvertedParameter(
        index = 1,
        name = "stmts",
        typeHint = "array",
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object declares = assignParameter(args, 0, false);
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("declares", "stmts"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Declare_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Declare_")
                    .setLookup(
                            Declare_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "declares", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Declare_.php")
