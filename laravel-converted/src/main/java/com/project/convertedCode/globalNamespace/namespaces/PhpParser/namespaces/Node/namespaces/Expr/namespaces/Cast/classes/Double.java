...
public class Double extends Cast {

    public Double(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Double.class) {
            this.__construct(env, args);
        }
    }

    public Double(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Cast\\Double";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Cast\\Double")
                    .setLookup(
                            Double.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Cast/Double.php")
