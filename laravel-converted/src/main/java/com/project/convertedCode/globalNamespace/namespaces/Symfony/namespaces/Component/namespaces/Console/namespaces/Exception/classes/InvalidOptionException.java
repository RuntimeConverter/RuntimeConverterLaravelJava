...
public class InvalidOptionException extends InvalidArgumentException implements ExceptionInterface {

    public InvalidOptionException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == InvalidOptionException.class) {
            this.__construct(env, args);
        }
    }

    public InvalidOptionException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\Console\\Exception\\InvalidOptionException")
                    .setLookup(
                            InvalidOptionException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/console/Exception/InvalidOptionException.php")
