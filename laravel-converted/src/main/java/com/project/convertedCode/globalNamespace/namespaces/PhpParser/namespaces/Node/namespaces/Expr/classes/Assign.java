...
public class Assign extends Expr {
    ...
    public Assign(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Assign.class) {
            this.__construct(env, args);
        }
    }

    public Assign(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Assign";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Assign")
                    .setLookup(
                            Assign.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Assign.php")
