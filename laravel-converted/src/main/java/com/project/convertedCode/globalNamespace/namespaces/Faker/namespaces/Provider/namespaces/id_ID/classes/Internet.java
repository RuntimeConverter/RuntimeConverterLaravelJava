...
public class Internet
    ...
    public static final Object CONST_class = "Faker\\Provider\\id_ID\\Internet";
    ...
    public static class RequestStaticProperties {
        ...
        public Object freeEmailDomain =
                ZVal.arrayFromList("gmail.com", "yahoo.com", "gmail.co.id", "yahoo.co.id");

        public Object tld =
                ZVal.arrayFromList(
                        "com", "net", "org", "asia", "tv", "biz", "info", "in", "name", "co",
                        "ac.id", "sch.id", "go.id", "mil.id", "co.id", "or.id", "web.id", "my.id",
                        "biz.id", "desa.id");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\id_ID\\Internet")
                    .setLookup(
                            Internet.class,
                    ...
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/id_ID/Internet.php")
