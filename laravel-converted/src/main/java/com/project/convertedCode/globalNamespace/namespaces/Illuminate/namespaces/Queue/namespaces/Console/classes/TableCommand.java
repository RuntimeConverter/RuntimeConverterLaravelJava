...
public class TableCommand extends Command {
    ...
    public TableCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "queue:table";
        this.description = "Create a migration for the queue jobs database table";
        if (this.getClass() == TableCommand.class) {
            this.__construct(env, args);
        }
    }

    public TableCommand(NoConstructor n) {
        super(n);
    }
        ...
        table =
                ZVal.assign(
                        new ReferenceClassProperty(this, "laravel", env)
                                .arrayGet(env, "config", "queue.connections.database.table"));
        this.replaceMigration(
                env,
                this.createBaseMigration(env, table),
                table,
                Str.runtimeStaticObject.studly(env, table));
        env.callMethod(this, "info", TableCommand.class, "Migration created successfully!");
        env.callMethod(this.composer, "dumpAutoloads", TableCommand.class);
        return null;
    }
                        ...
                        .call(
                                ...
                                env.callMethod(
                                        ...
                                        toStringR(
                                                ...
                                                + "/stubs/jobs.stub"))
                        .value();
        env.callMethod(this.files, "put", TableCommand.class, path, stub);
        return null;
    }

    public static final Object CONST_class = "Illuminate\\Queue\\Console\\TableCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Queue\\Console\\TableCommand")
                    .setLookup(
                            TableCommand.class,
