...
public class NoDomainPart extends InvalidEmail {

    public NoDomainPart(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NoDomainPart.class) {
            this.__construct(env, args);
        }
    }

    public NoDomainPart(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 131;

    public static final Object CONST_REASON = "No Domain part";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\NoDomainPart";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\NoDomainPart")
                    .setLookup(
                            NoDomainPart.class,
