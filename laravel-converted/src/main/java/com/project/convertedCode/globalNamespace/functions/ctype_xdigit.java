...
public class ctype_xdigit extends FunctionBaseRegular {

    public static ctype_xdigit f = new ctype_xdigit();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_xdigit(env, text));
    }
