...
public class AnonymousClass3545 extends RuntimeClassBase implements ExceptionHandler {

    public Object except = null;

    public Object originalHandler = null;

    public AnonymousClass3545(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AnonymousClass3545.class) {
            this.__construct(env, args);
        }
    }

    public AnonymousClass3545(NoConstructor n) {
        super(n);
    }
        ...
        if (ZVal.isTrue(
            ...
            throw ZVal.getException(
                    ...
                    new NotFoundHttpException(
                            ...
                            toStringR(
                                            env.callMethod(
                                                    request, "method", AnonymousClass3545.class),
                                            env)
                                    + " "
                                    + toStringR(
                                            env.callMethod(
                                                    request, "url", AnonymousClass3545.class),
                                            env),
                            ZVal.getNull(),
                            env.callMethod(e, "getCode", AnonymousClass3545.class)));
        }

        for (ZPair zpairResult2312 : ZVal.getIterable(this.except, env, true)) {
            _pClass = ZVal.assign(zpairResult2312.getValue());
            if (ZVal.isTrue(ZVal.checkInstanceTypeMatch(e, _pClass))) {
                return ZVal.assign(
                        env.callMethod(
                                this.originalHandler,
                                "render",
                                AnonymousClass3545.class,
                                request,
                                e));
            }
        }
    ...
    public Object renderForConsole(RuntimeEnv env, Object... args) {
        ...
        Object e = assignParameter(args, 1, false);
        env.callMethod(
                new Application(env), "renderException", AnonymousClass3545.class, e, output);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Testing\\Concerns\\AnonymousClass3545")
                    .setLookup(
                            AnonymousClass3545.class,
