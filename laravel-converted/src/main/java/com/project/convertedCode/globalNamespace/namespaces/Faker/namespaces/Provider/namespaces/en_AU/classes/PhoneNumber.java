...
public class PhoneNumber
    ...
    public static final Object CONST_class = "Faker\\Provider\\en_AU\\PhoneNumber";
    ...
    public static class RequestStaticProperties {
        ...
        public Object areacodes = ZVal.arrayFromList("2", "3", "7", "8");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\en_AU\\PhoneNumber")
                    .setLookup(
                            PhoneNumber.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("areacodes", "formats", "mobileFormats")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/en_AU/PhoneNumber.php")
