...
public class NoTmpDirFileException extends FileException {

    public NoTmpDirFileException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NoTmpDirFileException.class) {
            this.__construct(env, args);
        }
    }

    public NoTmpDirFileException(NoConstructor n) {
        super(n);
    }
