...
public class HaltCompiler extends Stmt {

    public Object remaining = null;

    public HaltCompiler(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == HaltCompiler.class) {
            this.__construct(env, args);
        }
    }

    public HaltCompiler(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "remaining", typeHint = "string")
    @ConvertedParameter(
        index = 1,
        name = "attributes",
        typeHint = "array",
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object remaining = assignParameter(args, 0, false);
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("remaining"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\HaltCompiler";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\HaltCompiler")
                    .setLookup(
                            HaltCompiler.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "remaining")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/HaltCompiler.php")
