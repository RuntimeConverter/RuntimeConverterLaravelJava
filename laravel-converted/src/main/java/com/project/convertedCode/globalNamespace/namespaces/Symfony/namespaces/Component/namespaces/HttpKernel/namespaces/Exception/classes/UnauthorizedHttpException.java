...
public class UnauthorizedHttpException extends HttpException {
    ...
    public UnauthorizedHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnauthorizedHttpException.class) {
            this.__construct(env, args);
        }
    }

    public UnauthorizedHttpException(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "challenge", typeHint = "string")
    @ConvertedParameter(
        index = 1,
        name = "message",
        typeHint = "string",
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object challenge = assignParameter(args, 0, false);
        ...
        headers.arrayAccess(env, "WWW-Authenticate").set(challenge);
        super.__construct(env, 401, message, previous, headers.getObject(), code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Exception\\UnauthorizedHttpException")
                    .setLookup(
