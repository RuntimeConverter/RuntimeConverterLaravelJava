...
public class JobExceptionOccurred extends RuntimeClassBase {
    ...
    public JobExceptionOccurred(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == JobExceptionOccurred.class) {
            this.__construct(env, args);
        }
    }

    public JobExceptionOccurred(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Queue\\Events\\JobExceptionOccurred";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Queue\\Events\\JobExceptionOccurred")
                    .setLookup(
