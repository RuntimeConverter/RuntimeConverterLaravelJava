...
public class Goto_ extends Stmt {

    public Object name = null;

    public Goto_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Goto_.class) {
            this.__construct(env, args);
        }
    }

    public Goto_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Goto_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Goto_")
                    .setLookup(
                            Goto_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Goto_.php")
