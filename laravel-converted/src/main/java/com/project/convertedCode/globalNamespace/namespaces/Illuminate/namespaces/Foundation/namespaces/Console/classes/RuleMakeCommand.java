...
public class RuleMakeCommand extends GeneratorCommand {

    public RuleMakeCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "make:rule";
        this.description = "Create a new validation rule";
        this.type = "Rule";
        if (this.getClass() == RuleMakeCommand.class) {
            this.__construct(env, args);
        }
    }

    public RuleMakeCommand(NoConstructor n) {
        super(n);
    }
    ...
    protected Object getDefaultNamespace(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(toStringR(rootNamespace, env) + "\\Rules");
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\RuleMakeCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\RuleMakeCommand")
                    .setLookup(
