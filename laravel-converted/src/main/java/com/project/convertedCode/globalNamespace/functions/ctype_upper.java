...
public class ctype_upper extends FunctionBaseRegular {

    public static ctype_upper f = new ctype_upper();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_upper(env, text));
    }
