...
public class PsyVersionCommand extends Command {

    public PsyVersionCommand(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PsyVersionCommand.class) {
            this.__construct(env, args);
        }
    }

    public PsyVersionCommand(NoConstructor n) {
        super(n);
    }
    ...
    protected Object configure(RuntimeEnv env, Object... args) {
        env.callMethod(
                env.callMethod(
                        env.callMethod(
                                env.callMethod(this, "setName", PsyVersionCommand.class, "version"),
                                "setDefinition",
                                PsyVersionCommand.class,
                                ZVal.newArray()),
                        "setDescription",
                        PsyVersionCommand.class,
    ...
    protected Object execute(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(
                ...
                PsyVersionCommand.class,
                env.callMethod(
                        env.callMethod(this, "getApplication", PsyVersionCommand.class),
                        "getVersion",
                        PsyVersionCommand.class));
        return null;
    }

    public static final Object CONST_class = "Psy\\Command\\PsyVersionCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Psy\\Command\\PsyVersionCommand")
                    .setLookup(
                            PsyVersionCommand.class,
                    ...
                    .setLocalProperties(
                            ...
                            "synopsis",
                            "usages")
                    .setFilename("vendor/psy/psysh/src/Command/PsyVersionCommand.php")
