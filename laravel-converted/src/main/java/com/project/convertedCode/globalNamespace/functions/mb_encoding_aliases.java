...
public class mb_encoding_aliases extends FunctionBaseRegular {

    public static mb_encoding_aliases f = new mb_encoding_aliases();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "encoding")
    public Object call(RuntimeEnv env, Object... args) {
        Object encoding = assignParameter(args, 0, false);
        return ZVal.assign(Mbstring.runtimeStaticObject.mb_encoding_aliases(env, encoding));
    }
