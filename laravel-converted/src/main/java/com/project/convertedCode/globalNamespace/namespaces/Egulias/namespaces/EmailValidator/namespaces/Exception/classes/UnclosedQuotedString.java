...
public class UnclosedQuotedString extends InvalidEmail {

    public UnclosedQuotedString(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnclosedQuotedString.class) {
            this.__construct(env, args);
        }
    }

    public UnclosedQuotedString(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 145;

    public static final Object CONST_REASON = "Unclosed quoted string";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\UnclosedQuotedString")
                    .setLookup(
                            UnclosedQuotedString.class,
