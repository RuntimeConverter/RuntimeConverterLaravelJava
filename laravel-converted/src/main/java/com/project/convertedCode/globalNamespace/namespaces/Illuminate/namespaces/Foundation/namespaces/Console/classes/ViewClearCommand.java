...
public class ViewClearCommand extends Command {

    public Object files = null;

    public ViewClearCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "view:clear";
        this.description = "Clear all compiled view files";
        if (this.getClass() == ViewClearCommand.class) {
            this.__construct(env, args);
        }
    }

    public ViewClearCommand(NoConstructor n) {
        super(n);
    }
    ...
    public Object handle(RuntimeEnv env, Object... args) {
        ...
        if (!ZVal.isTrue(path)) {
            throw ZVal.getException(env, new RuntimeException(env, "View path not found."));
        }
        ...
        for (ZPair zpairResult413 :
                ZVal.getIterable(
                        ...
                        env,
                        true)) {
            view = ZVal.assign(zpairResult413.getValue());
            env.callMethod(this.files, "delete", ViewClearCommand.class, view);
        }

        env.callMethod(this, "info", ViewClearCommand.class, "Compiled views cleared!");
        return null;
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\ViewClearCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\ViewClearCommand")
                    .setLookup(
                            ViewClearCommand.class,
