...
public class DotAtStart extends InvalidEmail {
    ...
    public DotAtStart(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == DotAtStart.class) {
            this.__construct(env, args);
        }
    }

    public DotAtStart(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 141;

    public static final Object CONST_REASON = "Found DOT at start";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\DotAtStart";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\DotAtStart")
                    .setLookup(
                            DotAtStart.class,
