...
public class Swift_Transport_Esmtp_EightBitMimeHandler extends RuntimeClassBase
        implements Swift_Transport_EsmtpHandler {

    public Object encoding = null;

    public Swift_Transport_Esmtp_EightBitMimeHandler(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Swift_Transport_Esmtp_EightBitMimeHandler.class) {
            this.__construct(env, args);
        }
    }

    public Swift_Transport_Esmtp_EightBitMimeHandler(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "encoding", typeHint = "string")
    ...
    public Object getMailParams(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.newArray(new ZPair(0, "BODY=" + toStringR(this.encoding, env))));
    }
    ...
    public static final Object CONST_class = "Swift_Transport_Esmtp_EightBitMimeHandler";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Swift_Transport_Esmtp_EightBitMimeHandler")
                    .setLookup(
                            Swift_Transport_Esmtp_EightBitMimeHandler.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("encoding")
                    .setFilename(
                            "vendor/swiftmailer/swiftmailer/lib/classes/Swift/Transport/Esmtp/EightBitMimeHandler.php")
