...
public class Unique extends RuntimeClassBase {

    public Object ignore = null;
    ...
    public Unique(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Unique.class) {
            this.__construct(env, args);
        }
    }

    public Unique(NoConstructor n) {
        super(n);
    }
    ...
    public Object ignore(RuntimeEnv env, Object... args) {
        Object id = assignParameter(args, 0, false);
        Object idColumn = assignParameter(args, 1, true);
        if (null == idColumn) {
            idColumn = ZVal.getNull();
        }
        Object ternaryExpressionTemp = null;
        if (ZVal.isTrue(
                ZVal.checkInstanceType(id, Model.class, "Illuminate\\Database\\Eloquent\\Model"))) {
            return ZVal.assign(this.ignoreModel(env, id, idColumn));
        }

        this.ignore = id;
        this.idColumn =
                ZVal.isDefined(ternaryExpressionTemp = idColumn) ? ternaryExpressionTemp : "id";
    ...
    public Object ignoreModel(RuntimeEnv env, Object... args) {
        ...
        Object ternaryExpressionTemp = null;
        this.idColumn =
                ZVal.isDefined(ternaryExpressionTemp = idColumn)
                        ? ternaryExpressionTemp
                        : env.callMethod(model, "getKeyName", Unique.class);
        this.ignore = toObjectR(model).accessProp(this, env).name(this.idColumn).value();
        return ZVal.assign(this);
    }
                        ...
                        .call(
                                function_sprintf
                                        ...
                                        .call(
                                                ...
                                                this.table,
                                                this.column,
                                                ZVal.isTrue(this.ignore)
                                                        ? "\"" + toStringR(this.ignore, env) + "\""
                                                        : "NULL",
                                                this.idColumn,
                                                this.formatWheres(env))
                                        .value(),
                                ",")
                        .value());
    }
                ...
                this.where(
                        ...
                        new Closure(
                            ...
                            public Object run(
                                ...
                                env.callMethod(query, "whereIn", Unique.class, column, values);
                                return null;
                            }
                ...
                this.where(
                        ...
                        new Closure(
                            ...
                            public Object run(
                                ...
                                values = this.contextReferences.getCapturedValue("values");
                                column = this.contextReferences.getCapturedValue("column");
                                env.callMethod(query, "whereNotIn", Unique.class, column, values);
                                return null;
                            }
                        }.use("values", values).use("column", column)));
    }
    ...
    public static final Object CONST_class = "Illuminate\\Validation\\Rules\\Unique";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Validation\\Rules\\Unique")
                    .setLookup(
                            Unique.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("column", "idColumn", "ignore", "table", "using", "wheres")
                    .setFilename(
                            "vendor/laravel/framework/src/Illuminate/Validation/Rules/Unique.php")
