...
public class Payment
    ...
    public static final Object CONST_class = "Faker\\Provider\\fr_BE\\Payment";
    ...
    public static class RuntimeStaticCompanion
        ...
        public Object vat(RuntimeEnv env, Object... args) {
            ...
            Object prefix = null;
            prefix = ZVal.assign(ZVal.isTrue(spacedNationalPrefix) ? "BE " : "BE");
            return ZVal.assign(
                    function_sprintf
                            .f
                            .env(env)
                            .call("%s0%d", prefix, runtimeStaticObject.randomNumber(env, 9, true))
                            .value());
        }
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\fr_BE\\Payment")
                    .setLookup(
                            Payment.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/fr_BE/Payment.php")
