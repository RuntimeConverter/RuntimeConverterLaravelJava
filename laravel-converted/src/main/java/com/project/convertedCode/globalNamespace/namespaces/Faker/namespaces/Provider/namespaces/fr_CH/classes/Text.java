...
public class Text
    ...
    public static final Object CONST_class = "Faker\\Provider\\fr_CH\\Text";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\fr_CH\\Text")
                    .setLookup(
                            Text.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("consecutiveWords", "explodedText", "generator", "unique")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/fr_CH/Text.php")
                    .addExtendsClass("Faker\\Provider\\fr_FR\\Text")
