...
public class Echo_ extends Stmt {

    public Object exprs = null;

    public Echo_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Echo_.class) {
            this.__construct(env, args);
        }
    }

    public Echo_(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "exprs", typeHint = "array")
    @ConvertedParameter(
        index = 1,
        name = "attributes",
        typeHint = "array",
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object exprs = assignParameter(args, 0, false);
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("exprs"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Echo_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Echo_")
                    .setLookup(
                            Echo_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "exprs")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Echo_.php")
