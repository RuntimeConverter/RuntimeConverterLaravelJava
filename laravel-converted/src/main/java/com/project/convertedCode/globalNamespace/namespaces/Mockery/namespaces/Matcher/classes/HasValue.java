...
public class HasValue extends MatcherAbstract {

    public HasValue(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == HasValue.class) {
            this.__construct(env, args);
        }
    }

    public HasValue(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Mockery\\Matcher\\HasValue";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Mockery\\Matcher\\HasValue")
                    .setLookup(
                            HasValue.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("_expected")
                    .setFilename("vendor/mockery/mockery/library/Mockery/Matcher/HasValue.php")
