...
public class NotEqual extends BinaryOp {
    ...
    public NotEqual(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NotEqual.class) {
            this.__construct(env, args);
        }
    }

    public NotEqual(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\NotEqual";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\NotEqual")
                    .setLookup(
                            NotEqual.class,
