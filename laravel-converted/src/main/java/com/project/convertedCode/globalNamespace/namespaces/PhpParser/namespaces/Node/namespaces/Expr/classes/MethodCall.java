...
public class MethodCall extends Expr {
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("var", "name", "args"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\MethodCall";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\MethodCall")
                    .setLookup(
                            MethodCall.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("args", "attributes", "name", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/MethodCall.php")
