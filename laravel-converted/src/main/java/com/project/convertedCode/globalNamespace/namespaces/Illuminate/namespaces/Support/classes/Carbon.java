...
public class Carbon
        extends com.project.convertedCode.globalNamespace.namespaces.Carbon.classes.Carbon
                        ...
                        .call(
                                new Closure(
                                    ...
                                    public Object run(
                                            ...
                                            Object... args) {
                                        Object carbon = null;
                                        carbon = this.contextReferences.getCapturedValue("carbon");
                                        return ZVal.assign(
                                                NamespaceGlobal.get_object_vars
                                                        .env(env)
                                                        .call(carbon)
                                                        .value());
                                    }
    ...
    public static final Object CONST_class = "Illuminate\\Support\\Carbon";
    ...
    public static class RuntimeStaticCompanion
        ...
        public Object serializeUsing(RuntimeEnv env, Object... args) {
        ...
        public Object mixin(RuntimeEnv env, Object... args) {
            ...
            for (ZPair zpairResult2360 : ZVal.getIterable(methods, env, true)) {
                method = ZVal.assign(zpairResult2360.getValue());
                env.callMethod(method, "setAccessible", Carbon.class, true);
                StaticMethodUtils.accessUnknownLateStaticMethod(env, this, Carbon.class)
                        .method("macro")
                        .addReferenceArgs(new RuntimeArgsWithReferences())
                        .call(
                                toObjectR(method).accessProp(this, env).name("name").value(),
                                env.callMethod(method, "invoke", Carbon.class, mixin))
                        .value();
            }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Carbon")
                    .setLookup(
                            Carbon.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setStaticPropertyNames("macros", "serializer")
                    .setFilename("vendor/laravel/framework/src/Illuminate/Support/Carbon.php")
                    .addInterface("JsonSerializable")
                    .addInterface("DateTimeInterface")
                    .addTrait("Illuminate\\Support\\Traits\\Macroable")
                    .addExtendsClass("Carbon\\Carbon")
