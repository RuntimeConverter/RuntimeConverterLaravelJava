...
public class MiddlewareMakeCommand extends GeneratorCommand {

    public MiddlewareMakeCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "make:middleware";
        this.description = "Create a new middleware class";
        this.type = "Middleware";
        if (this.getClass() == MiddlewareMakeCommand.class) {
            this.__construct(env, args);
        }
    }

    public MiddlewareMakeCommand(NoConstructor n) {
        super(n);
    }
    ...
    protected Object getDefaultNamespace(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(toStringR(rootNamespace, env) + "\\Http\\Middleware");
    }

    public static final Object CONST_class = "Illuminate\\Routing\\Console\\MiddlewareMakeCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Routing\\Console\\MiddlewareMakeCommand")
                    .setLookup(
