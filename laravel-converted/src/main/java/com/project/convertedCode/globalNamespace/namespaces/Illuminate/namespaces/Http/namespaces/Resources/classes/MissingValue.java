...
public class MissingValue extends RuntimeClassBase implements PotentiallyMissing {

    public MissingValue(RuntimeEnv env, Object... args) {
        super(env);
    }

    public MissingValue(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Http\\Resources\\MissingValue";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Http\\Resources\\MissingValue")
                    .setLookup(
                            MissingValue.class,
                    ...
                    .setFilename(
                            "vendor/laravel/framework/src/Illuminate/Http/Resources/MissingValue.php")
                    .addInterface("Illuminate\\Http\\Resources\\PotentiallyMissing")
                    .get();
