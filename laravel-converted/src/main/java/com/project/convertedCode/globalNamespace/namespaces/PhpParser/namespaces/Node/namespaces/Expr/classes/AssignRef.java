...
public class AssignRef extends Expr {

    public Object var = null;

    public Object expr = null;

    public AssignRef(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AssignRef.class) {
            this.__construct(env, args);
        }
    }

    public AssignRef(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "var", typeHint = "PhpParser\\Node\\Expr")
    @ConvertedParameter(index = 1, name = "expr", typeHint = "PhpParser\\Node\\Expr")
    @ConvertedParameter(
        index = 2,
        name = "attributes",
        typeHint = "array",
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("var", "expr"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignRef";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignRef")
                    .setLookup(
                            AssignRef.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/AssignRef.php")
