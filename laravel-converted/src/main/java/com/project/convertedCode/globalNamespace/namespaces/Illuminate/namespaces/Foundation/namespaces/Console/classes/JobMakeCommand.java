...
public class JobMakeCommand extends GeneratorCommand {

    public JobMakeCommand(RuntimeEnv env, Object... args) {
        super(env);
        // Super class property overrides
        this.name = "make:job";
        this.description = "Create a new job class";
        this.type = "Job";
        if (this.getClass() == JobMakeCommand.class) {
            this.__construct(env, args);
        }
    }

    public JobMakeCommand(NoConstructor n) {
        super(n);
    }
    ...
    protected Object getStub(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.isTrue(env.callMethod(this, "option", JobMakeCommand.class, "sync"))
                        ? toStringR(
    ...
    protected Object getDefaultNamespace(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(toStringR(rootNamespace, env) + "\\Jobs");
    }
                ...
                ZVal.newArray(
                        new ZPair(
                                ...
                                ZVal.newArray(
                                        ...
                                        new ZPair(
                                                3, "Indicates that job should be synchronous.")))));
    }

    public static final Object CONST_class = "Illuminate\\Foundation\\Console\\JobMakeCommand";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Console\\JobMakeCommand")
                    .setLookup(
