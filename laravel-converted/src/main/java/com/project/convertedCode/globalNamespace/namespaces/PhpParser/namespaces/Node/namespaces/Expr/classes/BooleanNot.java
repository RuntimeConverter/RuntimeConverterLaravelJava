...
public class BooleanNot extends Expr {

    public Object expr = null;

    public BooleanNot(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == BooleanNot.class) {
            this.__construct(env, args);
        }
    }

    public BooleanNot(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BooleanNot";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BooleanNot")
                    .setLookup(
                            BooleanNot.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/BooleanNot.php")
