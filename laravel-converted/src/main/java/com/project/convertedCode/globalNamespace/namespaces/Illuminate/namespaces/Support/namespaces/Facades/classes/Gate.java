...
public class Gate extends Facade {
    ...
    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Gate";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Gate")
                    .setLookup(
                            Gate.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/laravel/framework/src/Illuminate/Support/Facades/Gate.php")
