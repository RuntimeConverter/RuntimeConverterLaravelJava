...
public class database_path extends FunctionBaseRegular {

    public static database_path f = new database_path();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(
                env.callMethod(
                        app.f.env(env).call().value(), "databasePath", database_path.class, path));
    }
