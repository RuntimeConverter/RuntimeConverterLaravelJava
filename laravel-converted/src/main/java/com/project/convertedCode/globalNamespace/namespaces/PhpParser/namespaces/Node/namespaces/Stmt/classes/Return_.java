...
public class Return_ extends Stmt {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Return_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Return_")
                    .setLookup(
                            Return_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Return_.php")
