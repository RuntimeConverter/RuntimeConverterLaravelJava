...
public class ExpectingCTEXT extends InvalidEmail {

    public ExpectingCTEXT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ExpectingCTEXT.class) {
            this.__construct(env, args);
        }
    }

    public ExpectingCTEXT(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 139;

    public static final Object CONST_REASON = "Expecting CTEXT";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\ExpectingCTEXT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\ExpectingCTEXT")
                    .setLookup(
                            ExpectingCTEXT.class,
