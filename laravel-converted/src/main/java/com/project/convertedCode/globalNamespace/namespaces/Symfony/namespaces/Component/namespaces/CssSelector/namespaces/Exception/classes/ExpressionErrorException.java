...
public class ExpressionErrorException extends ParseException {

    public ExpressionErrorException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ExpressionErrorException.class) {
            this.__construct(env, args);
        }
    }

    public ExpressionErrorException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\CssSelector\\Exception\\ExpressionErrorException")
                    .setLookup(
                            ExpressionErrorException.class,
