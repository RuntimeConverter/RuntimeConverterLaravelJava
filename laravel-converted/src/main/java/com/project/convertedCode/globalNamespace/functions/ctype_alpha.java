...
public class ctype_alpha extends FunctionBaseRegular {

    public static ctype_alpha f = new ctype_alpha();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_alpha(env, text));
    }
