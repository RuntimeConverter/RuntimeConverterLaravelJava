...
public class Exit_ extends Expr {

    public Object expr = null;

    public Exit_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Exit_.class) {
            this.__construct(env, args);
        }
    }

    public Exit_(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        Object expr = assignParameter(args, 0, true);
        if (null == expr) {
            expr = ZVal.getNull();
        }
    ...
    public static final Object CONST_KIND_EXIT = 1;

    public static final Object CONST_KIND_DIE = 2;

    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Exit_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Exit_")
                    .setLookup(
                            Exit_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Exit_.php")
