...
public class MissingMandatoryParametersException extends InvalidArgumentException
        implements ExceptionInterface {

    public MissingMandatoryParametersException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == MissingMandatoryParametersException.class) {
            this.__construct(env, args);
        }
    }

    public MissingMandatoryParametersException(NoConstructor n) {
        super(n);
    }
