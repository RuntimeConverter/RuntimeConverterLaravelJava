...
public class Response extends Facade {
    ...
    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Response";
    ...
    public static class RuntimeStaticCompanion extends Facade.RuntimeStaticCompanion {
        ...
        protected Object getFacadeAccessor(RuntimeEnv env, Object... args) {
            return ZVal.assign(ResponseFactory.CONST_class);
        }
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Response")
                    .setLookup(
                            Response.class,
