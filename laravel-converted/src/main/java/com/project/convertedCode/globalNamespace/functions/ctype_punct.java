...
public class ctype_punct extends FunctionBaseRegular {

    public static ctype_punct f = new ctype_punct();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_punct(env, text));
    }
