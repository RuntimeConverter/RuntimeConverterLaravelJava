...
public class Eval_ extends Expr {

    public Object expr = null;

    public Eval_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Eval_.class) {
            this.__construct(env, args);
        }
    }

    public Eval_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Eval_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Eval_")
                    .setLookup(
                            Eval_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Eval_.php")
