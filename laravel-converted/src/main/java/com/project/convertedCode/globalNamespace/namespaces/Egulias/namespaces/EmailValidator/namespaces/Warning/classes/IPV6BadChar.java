...
public class IPV6BadChar extends Warning {
    ...
    public IPV6BadChar(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IPV6BadChar.class) {
            this.__construct(env, args);
        }
    }

    public IPV6BadChar(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this)
                .accessProp(this, env)
                .name("message")
                .set("Bad char in IPV6 domain literal");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5322);
        return null;
    }

    public static final Object CONST_CODE = 74;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\IPV6BadChar";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\IPV6BadChar")
                    .setLookup(
                            IPV6BadChar.class,
