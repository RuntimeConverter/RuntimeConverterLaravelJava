...
public class AnonymousClass1067 extends RuntimeClassBase {

    public AnonymousClass1067(RuntimeEnv env, Object... args) {
        super(env);
    }

    public AnonymousClass1067(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "request")
    @ConvertedParameter(index = 1, name = "next")
    ...
    public static final Object CONST_class =
            "Illuminate\\Foundation\\Testing\\Concerns\\AnonymousClass1067";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Foundation\\Testing\\Concerns\\AnonymousClass1067")
                    .setLookup(
                            AnonymousClass1067.class,
