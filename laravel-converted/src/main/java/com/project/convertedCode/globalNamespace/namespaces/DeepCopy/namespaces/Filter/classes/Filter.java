...
public interface Filter {
    ...
    public static final Object CONST_class = "DeepCopy\\Filter\\Filter";
    ...
    static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("DeepCopy\\Filter\\Filter")
                    .setLookup(Filter.class, MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/myclabs/deep-copy/src/DeepCopy/Filter/Filter.php")
                    .get();
}
