...
public class DomainLiteral extends Warning {
    ...
    public DomainLiteral(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == DomainLiteral.class) {
            this.__construct(env, args);
        }
    }

    public DomainLiteral(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("Domain Literal");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5322);
        return null;
    }

    public static final Object CONST_CODE = 70;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\DomainLiteral";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\DomainLiteral")
                    .setLookup(
                            DomainLiteral.class,
