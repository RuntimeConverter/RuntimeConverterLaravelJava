...
public class Static_ extends Stmt {

    public Object vars = null;

    public Static_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Static_.class) {
            this.__construct(env, args);
        }
    }

    public Static_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Static_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Static_")
                    .setLookup(
                            Static_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "vars")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Static_.php")
