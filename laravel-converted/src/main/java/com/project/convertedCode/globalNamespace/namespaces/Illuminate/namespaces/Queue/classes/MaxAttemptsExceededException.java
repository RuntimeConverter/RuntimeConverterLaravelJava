...
public class MaxAttemptsExceededException extends RuntimeException {
    ...
    public MaxAttemptsExceededException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == MaxAttemptsExceededException.class) {
            this.__construct(env, args);
        }
    }

    public MaxAttemptsExceededException(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Queue\\MaxAttemptsExceededException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Queue\\MaxAttemptsExceededException")
                    .setLookup(
