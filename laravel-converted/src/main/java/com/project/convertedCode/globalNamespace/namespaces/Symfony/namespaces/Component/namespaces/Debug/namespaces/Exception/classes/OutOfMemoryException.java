...
public class OutOfMemoryException extends FatalErrorException {

    public OutOfMemoryException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == OutOfMemoryException.class) {
            this.__construct(env, args);
        }
    }

    public OutOfMemoryException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\Debug\\Exception\\OutOfMemoryException")
                    .setLookup(
                            OutOfMemoryException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/debug/Exception/OutOfMemoryException.php")
