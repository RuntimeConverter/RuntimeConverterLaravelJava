...
public class ConstFetch extends Expr {

    public Object name = null;

    public ConstFetch(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ConstFetch.class) {
            this.__construct(env, args);
        }
    }

    public ConstFetch(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\ConstFetch";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\ConstFetch")
                    .setLookup(
                            ConstFetch.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "name")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/ConstFetch.php")
