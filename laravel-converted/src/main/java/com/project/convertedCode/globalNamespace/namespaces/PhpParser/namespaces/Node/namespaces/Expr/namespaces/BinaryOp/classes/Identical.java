...
public class Identical extends BinaryOp {

    public Identical(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Identical.class) {
            this.__construct(env, args);
        }
    }

    public Identical(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Identical";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Identical")
                    .setLookup(
                            Identical.class,
