...
public class Case_ extends Stmt {

    public Object cond = null;

    public Object stmts = null;

    public Case_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Case_.class) {
            this.__construct(env, args);
        }
    }

    public Case_(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "cond")
    @ConvertedParameter(
        index = 1,
        name = "stmts",
        typeHint = "array",
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Case_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Case_")
                    .setLookup(
                            Case_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "cond", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Case_.php")
