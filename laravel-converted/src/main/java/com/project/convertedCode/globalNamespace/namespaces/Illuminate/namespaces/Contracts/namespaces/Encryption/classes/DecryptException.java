...
public class DecryptException extends RuntimeException {
    ...
    public DecryptException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == DecryptException.class) {
            this.__construct(env, args);
        }
    }

    public DecryptException(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_class = "Illuminate\\Contracts\\Encryption\\DecryptException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Contracts\\Encryption\\DecryptException")
                    .setLookup(
