...
public class URL extends Facade {
    ...
    public static final Object CONST_class = "Illuminate\\Support\\Facades\\URL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\URL")
                    .setLookup(
                            URL.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/laravel/framework/src/Illuminate/Support/Facades/URL.php")
