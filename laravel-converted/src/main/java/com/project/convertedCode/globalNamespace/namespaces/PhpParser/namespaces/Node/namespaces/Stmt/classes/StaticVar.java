...
public class StaticVar extends Stmt {

    public Object var = null;

    public Object _pDefault = null;

    public StaticVar(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == StaticVar.class) {
            this.__construct(env, args);
        }
    }

    public StaticVar(NoConstructor n) {
        super(n);
    }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("var", "default"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\StaticVar";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\StaticVar")
                    .setLookup(
                            StaticVar.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "default", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/StaticVar.php")
