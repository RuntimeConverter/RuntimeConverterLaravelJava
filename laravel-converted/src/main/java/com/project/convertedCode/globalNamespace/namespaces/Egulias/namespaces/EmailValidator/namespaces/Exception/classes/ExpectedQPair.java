...
public class ExpectedQPair extends InvalidEmail {

    public ExpectedQPair(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ExpectedQPair.class) {
            this.__construct(env, args);
        }
    }

    public ExpectedQPair(NoConstructor n) {
        super(n);
    }

    public static final Object CONST_CODE = 136;

    public static final Object CONST_REASON = "Expecting QPAIR";

    public static final Object CONST_class = "Egulias\\EmailValidator\\Exception\\ExpectedQPair";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Exception\\ExpectedQPair")
                    .setLookup(
                            ExpectedQPair.class,
