...
public class ClassParser extends RuntimeClassBase implements ParserInterface {

    public ClassParser(RuntimeEnv env, Object... args) {
        super(env);
    }

    public ClassParser(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\CssSelector\\Parser\\Shortcut\\ClassParser")
                    .setLookup(
                            ClassParser.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties()
                    .setFilename("vendor/symfony/css-selector/Parser/Shortcut/ClassParser.php")
