...
public class Plus extends AssignOp {

    public Plus(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Plus.class) {
            this.__construct(env, args);
        }
    }

    public Plus(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\Plus";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\Plus")
                    .setLookup(
                            Plus.class,
