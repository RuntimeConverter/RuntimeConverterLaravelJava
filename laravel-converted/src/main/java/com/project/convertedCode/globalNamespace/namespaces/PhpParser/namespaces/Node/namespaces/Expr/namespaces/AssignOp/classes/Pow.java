...
public class Pow extends AssignOp {

    public Pow(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Pow.class) {
            this.__construct(env, args);
        }
    }

    public Pow(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\AssignOp\\Pow";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\AssignOp\\Pow")
                    .setLookup(
                            Pow.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/AssignOp/Pow.php")
