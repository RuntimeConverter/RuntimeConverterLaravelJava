...
public class Password extends Facade {

    public Password(RuntimeEnv env, Object... args) {
        super(env);
    }

    public Password(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Support\\Facades\\Password";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Support\\Facades\\Password")
                    .setLookup(
                            Password.class,
