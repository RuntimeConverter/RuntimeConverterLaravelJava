...
public class FilterResponseEvent extends KernelEvent {

    public Object response = null;

    public FilterResponseEvent(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == FilterResponseEvent.class) {
            this.__construct(env, args);
        }
    }

    public FilterResponseEvent(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        Object response = assignParameter(args, 3, false);
        super.__construct(env, kernel, request, requestType);
        this.setResponse(env, response);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpKernel\\Event\\FilterResponseEvent")
                    .setLookup(
                    ...
                    .setFilename("vendor/symfony/http-kernel/Event/FilterResponseEvent.php")
