...
public class Switch_ extends Stmt {

    public Object cond = null;

    public Object cases = null;

    public Switch_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Switch_.class) {
            this.__construct(env, args);
        }
    }

    public Switch_(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "cond", typeHint = "PhpParser\\Node\\Expr")
    @ConvertedParameter(index = 1, name = "cases", typeHint = "array")
    @ConvertedParameter(
        index = 2,
        name = "attributes",
        typeHint = "array",
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        Object cases = assignParameter(args, 1, false);
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("cond", "cases"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Switch_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Switch_")
                    .setLookup(
                            Switch_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "cases", "cond")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Switch_.php")
