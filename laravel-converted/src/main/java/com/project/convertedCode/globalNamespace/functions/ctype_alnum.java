...
public class ctype_alnum extends FunctionBaseRegular {

    public static ctype_alnum f = new ctype_alnum();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_alnum(env, text));
    }
