...
public class Payment
    ...
    public static final Object CONST_class = "Faker\\Provider\\es_ES\\Payment";
        ...
        public Object vat(RuntimeEnv env, Object... args) {
            ...
            number =
                    StaticMethodUtils.accessUnknownLateStaticMethod(env, this, Payment.class)
                            ...
                            .call("########")
                            .value();
            return ZVal.assign(toStringR(letter, env) + toStringR(number, env));
        }
    }
    ...
    public static class RequestStaticProperties {
        ...
        public Object vatMap =
                ZVal.arrayFromList(
                        "A", "B", "C", "D", "E", "F", "G", "H", "J", "N", "P", "Q", "R", "S", "U",
                        "V", "W");
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\es_ES\\Payment")
                    .setLookup(
                            Payment.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("vatMap")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/es_ES/Payment.php")
