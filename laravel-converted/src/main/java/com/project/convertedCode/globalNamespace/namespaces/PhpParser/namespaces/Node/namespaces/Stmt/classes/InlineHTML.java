...
public class InlineHTML extends Stmt {

    public Object value = null;

    public InlineHTML(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == InlineHTML.class) {
            this.__construct(env, args);
        }
    }

    public InlineHTML(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\InlineHTML";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\InlineHTML")
                    .setLookup(
                            InlineHTML.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "value")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/InlineHTML.php")
