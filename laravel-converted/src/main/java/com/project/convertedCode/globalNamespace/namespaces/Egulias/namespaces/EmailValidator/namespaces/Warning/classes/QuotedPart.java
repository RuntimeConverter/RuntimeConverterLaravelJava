...
public class QuotedPart extends Warning {
    ...
    public QuotedPart(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == QuotedPart.class) {
            this.__construct(env, args);
        }
    }

    public QuotedPart(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        toObjectR(this)
                ...
                .name("message")
                .set(
                        "Deprecated Quoted String found between "
    ...
    public static final Object CONST_CODE = 36;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\QuotedPart";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\QuotedPart")
                    .setLookup(
                            QuotedPart.class,
