...
public class SmallerOrEqual extends BinaryOp {

    public SmallerOrEqual(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == SmallerOrEqual.class) {
            this.__construct(env, args);
        }
    }

    public SmallerOrEqual(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\SmallerOrEqual";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\SmallerOrEqual")
                    .setLookup(
