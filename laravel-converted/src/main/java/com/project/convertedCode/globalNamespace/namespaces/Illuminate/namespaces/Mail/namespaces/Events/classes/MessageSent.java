...
public class MessageSent extends RuntimeClassBase {

    public Object message = null;

    public Object data = null;

    public MessageSent(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == MessageSent.class) {
            this.__construct(env, args);
        }
    }

    public MessageSent(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Mail\\Events\\MessageSent";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Mail\\Events\\MessageSent")
                    .setLookup(
                            MessageSent.class,
