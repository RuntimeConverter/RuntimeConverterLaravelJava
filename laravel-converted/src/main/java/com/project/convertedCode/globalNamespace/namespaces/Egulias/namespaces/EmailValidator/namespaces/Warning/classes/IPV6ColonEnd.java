...
public class IPV6ColonEnd extends Warning {
    ...
    public IPV6ColonEnd(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IPV6ColonEnd.class) {
            this.__construct(env, args);
        }
    }

    public IPV6ColonEnd(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this)
                .accessProp(this, env)
                .name("message")
                .set(":: found at the end of the domain literal");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5322);
        return null;
    }

    public static final Object CONST_CODE = 77;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\IPV6ColonEnd";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\IPV6ColonEnd")
                    .setLookup(
                            IPV6ColonEnd.class,
