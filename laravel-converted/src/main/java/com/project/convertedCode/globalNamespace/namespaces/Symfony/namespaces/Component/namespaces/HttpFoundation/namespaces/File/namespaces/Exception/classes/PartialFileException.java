...
public class PartialFileException extends FileException {

    public PartialFileException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PartialFileException.class) {
            this.__construct(env, args);
        }
    }

    public PartialFileException(NoConstructor n) {
        super(n);
    }
