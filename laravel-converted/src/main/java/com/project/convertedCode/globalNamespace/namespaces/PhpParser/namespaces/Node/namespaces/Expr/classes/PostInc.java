...
public class PostInc extends Expr {
    ...
    public PostInc(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PostInc.class) {
            this.__construct(env, args);
        }
    }

    public PostInc(NoConstructor n) {
        super(n);
    }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("var"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\PostInc";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\PostInc")
                    .setLookup(
                            PostInc.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "var")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/PostInc.php")
