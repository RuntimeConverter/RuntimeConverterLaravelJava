...
public class Unset_ extends Stmt {
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Unset_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Unset_")
                    .setLookup(
                            Unset_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "vars")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Unset_.php")
