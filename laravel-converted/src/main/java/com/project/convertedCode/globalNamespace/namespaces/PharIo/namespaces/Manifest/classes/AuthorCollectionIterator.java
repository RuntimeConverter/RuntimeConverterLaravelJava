...
public class AuthorCollectionIterator extends RuntimeClassBase implements Iterator {
    ...
    public AuthorCollectionIterator(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        this.authors = env.callMethod(authors, "getAuthors", AuthorCollectionIterator.class);
        return null;
    }
    ...
    public Object valid(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                ZVal.isLessThan(
                        this.position, '<', function_count.f.env(env).call(this.authors).value()));
    }
    ...
    public Object current(RuntimeEnv env, Object... args) {
        return ZVal.assign(
                new ReferenceClassProperty(this, "authors", env).arrayGet(env, this.position));
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    ...
                    .setLookup(
                            AuthorCollectionIterator.class,
