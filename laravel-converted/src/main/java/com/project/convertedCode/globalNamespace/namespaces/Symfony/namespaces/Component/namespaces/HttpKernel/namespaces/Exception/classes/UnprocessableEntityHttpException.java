...
public class UnprocessableEntityHttpException extends HttpException {
    ...
    public UnprocessableEntityHttpException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnprocessableEntityHttpException.class) {
            this.__construct(env, args);
        }
    }

    public UnprocessableEntityHttpException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 422, message, previous, headers, code);
        return null;
    }
