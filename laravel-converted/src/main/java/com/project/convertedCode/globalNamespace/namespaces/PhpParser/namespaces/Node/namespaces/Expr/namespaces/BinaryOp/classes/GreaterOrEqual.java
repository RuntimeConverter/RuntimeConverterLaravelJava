...
public class GreaterOrEqual extends BinaryOp {
    ...
    public GreaterOrEqual(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == GreaterOrEqual.class) {
            this.__construct(env, args);
        }
    }

    public GreaterOrEqual(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\GreaterOrEqual";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\GreaterOrEqual")
                    .setLookup(
