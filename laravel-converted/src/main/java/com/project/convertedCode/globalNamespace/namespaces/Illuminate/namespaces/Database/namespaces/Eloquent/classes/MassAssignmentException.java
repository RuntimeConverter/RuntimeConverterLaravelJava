...
public class MassAssignmentException extends RuntimeException {
    ...
    public MassAssignmentException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == MassAssignmentException.class) {
            this.__construct(env, args);
        }
    }

    public MassAssignmentException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Database\\Eloquent\\MassAssignmentException")
                    .setLookup(
