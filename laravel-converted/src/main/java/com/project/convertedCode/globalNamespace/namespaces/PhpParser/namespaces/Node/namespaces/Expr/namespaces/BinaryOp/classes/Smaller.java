...
public class Smaller extends BinaryOp {
    ...
    public Smaller(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Smaller.class) {
            this.__construct(env, args);
        }
    }

    public Smaller(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Smaller";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Smaller")
                    .setLookup(
                            Smaller.class,
