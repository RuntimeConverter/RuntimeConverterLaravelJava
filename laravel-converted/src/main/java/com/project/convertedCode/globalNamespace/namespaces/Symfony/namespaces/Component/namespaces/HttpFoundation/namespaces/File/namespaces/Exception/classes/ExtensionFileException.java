...
public class ExtensionFileException extends FileException {

    public ExtensionFileException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ExtensionFileException.class) {
            this.__construct(env, args);
        }
    }

    public ExtensionFileException(NoConstructor n) {
        super(n);
    }
