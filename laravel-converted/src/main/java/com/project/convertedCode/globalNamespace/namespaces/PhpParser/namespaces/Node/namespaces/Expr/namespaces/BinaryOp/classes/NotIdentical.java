...
public class NotIdentical extends BinaryOp {

    public NotIdentical(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == NotIdentical.class) {
            this.__construct(env, args);
        }
    }

    public NotIdentical(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\NotIdentical";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\NotIdentical")
                    .setLookup(
                            NotIdentical.class,
