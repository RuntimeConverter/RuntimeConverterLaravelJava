...
public class Equal extends BinaryOp {
    ...
    public Equal(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Equal.class) {
            this.__construct(env, args);
        }
    }

    public Equal(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Equal";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Equal")
                    .setLookup(
                            Equal.class,
