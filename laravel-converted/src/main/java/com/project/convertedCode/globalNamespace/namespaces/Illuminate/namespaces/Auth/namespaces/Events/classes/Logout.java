...
public class Logout extends RuntimeClassBase {

    public Object user = null;

    public Logout(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Logout.class) {
            this.__construct(env, args);
        }
    }

    public Logout(NoConstructor n) {
        super(n);
    }
    ...
    public Object __sleep(RuntimeEnv env, Object... args) {
        ...
        properties = env.callMethod(new ReflectionClass(env, this), "getProperties", Logout.class);
        for (ZPair zpairResult2259 : ZVal.getIterable(properties, env, true)) {
            property = ZVal.assign(zpairResult2259.getValue());
            env.callMethod(
                    property,
                    "setValue",
                    Logout.class,
    ...
    public Object __wakeup(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult2260 :
                ZVal.getIterable(
                        env.callMethod(
                                new ReflectionClass(env, this), "getProperties", Logout.class),
                        env,
                        true)) {
            property = ZVal.assign(zpairResult2260.getValue());
            if (ZVal.isTrue(env.callMethod(property, "isStatic", Logout.class))) {
                continue;
            }
    ...
    protected Object getPropertyValue(RuntimeEnv env, Object... args) {
        ...
        env.callMethod(property, "setAccessible", Logout.class, true);
        return ZVal.assign(env.callMethod(property, "getValue", Logout.class, this));
    }
        ...
        if (ZVal.isTrue(ZVal.checkInstanceType(value, (Class) null, "QueueableCollection", env))) {
            return ZVal.assign(
                    env.createNew(
                            ...
                            env.callMethod(value, "getQueueableClass", Logout.class),
                            env.callMethod(value, "getQueueableIds", Logout.class),
                            env.callMethod(value, "getQueueableRelations", Logout.class),
                            env.callMethod(value, "getQueueableConnection", Logout.class)));
        }
        ...
        if (ZVal.isTrue(ZVal.checkInstanceType(value, (Class) null, "QueueableEntity", env))) {
            return ZVal.assign(
                    env.createNew(
                            ...
                            env.callMethod(value, "getQueueableId", Logout.class),
                            env.callMethod(value, "getQueueableRelations", Logout.class),
                            env.callMethod(value, "getQueueableConnection", Logout.class)));
        }
    ...
    protected Object getQueryForModelRestoration(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(env.callMethod(model, "newQueryForRestoration", Logout.class, ids));
    }

    public static final Object CONST_class = "Illuminate\\Auth\\Events\\Logout";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Auth\\Events\\Logout")
                    .setLookup(
                            Logout.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("user")
                    .setFilename("vendor/laravel/framework/src/Illuminate/Auth/Events/Logout.php")
