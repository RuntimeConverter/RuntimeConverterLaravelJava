...
import com.project.convertedCode.globalNamespace.namespaces.Faker.namespaces.ORM.namespaces.Propel2.classes.ColumnTypeGuesser;
...
public class EntityPopulator extends RuntimeClassBase {
    ...
    public Object guessColumnFormatters(RuntimeEnv env, Object... args) {
        ...
        peerClass =
                ZVal.assign(ClassConstantUtils.getConstantValueByClass(env, _pClass, "TABLE_MAP"));
        tableMap =
        ...
        for (ZPair zpairResult94 :
            ...
            columnMap = ZVal.assign(zpairResult94.getValue());
    ...
    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "columnMap", typeHint = "Propel\\Runtime\\Map\\ColumnMap")
    protected Object isColumnBehavior(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult95 :
                ZVal.getIterable(
                        ...
                        env,
                        false)) {
            name = ZVal.assign(zpairResult95.getKey());
            params.setObject(ZVal.assign(zpairResult95.getValue()));
            columnName =
    ...
    public Object guessModifiers(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult96 :
                ZVal.getIterable(
                        ...
                        env,
                        false)) {
            name = ZVal.assign(zpairResult96.getKey());
            params = ZVal.assign(zpairResult96.getValue());
            switch (toStringR(name)) {
                case "nested_set":
                    modifiers
    ...
    public Object execute(RuntimeEnv env, Object... args) {
        ...
        for (ZPair zpairResult97 : ZVal.getIterable(this.getColumnFormatters(env), env, false)) {
            column = ZVal.assign(zpairResult97.getKey());
            format = ZVal.assign(zpairResult97.getValue());
        ...
        for (ZPair zpairResult98 : ZVal.getIterable(this.getModifiers(env), env, true)) {
            modifier = ZVal.assign(zpairResult98.getValue());
            env.callFunctionDynamic(
                    modifier,
    ...
    public static final Object CONST_class = "Faker\\ORM\\Propel2\\EntityPopulator";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\ORM\\Propel2\\EntityPopulator")
                    .setLookup(
                            EntityPopulator.class,
