...
public class IPV6Deprecated extends Warning {
    ...
    public IPV6Deprecated(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IPV6Deprecated.class) {
            this.__construct(env, args);
        }
    }

    public IPV6Deprecated(NoConstructor n) {
        super(n);
    }

    @ConvertedMethod
    public Object __construct(RuntimeEnv env, Object... args) {
        toObjectR(this).accessProp(this, env).name("message").set("Deprecated form of IPV6");
        toObjectR(this).accessProp(this, env).name("rfcNumber").set(5321);
        return null;
    }

    public static final Object CONST_CODE = 13;

    public static final Object CONST_class = "Egulias\\EmailValidator\\Warning\\IPV6Deprecated";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Egulias\\EmailValidator\\Warning\\IPV6Deprecated")
                    .setLookup(
                            IPV6Deprecated.class,
