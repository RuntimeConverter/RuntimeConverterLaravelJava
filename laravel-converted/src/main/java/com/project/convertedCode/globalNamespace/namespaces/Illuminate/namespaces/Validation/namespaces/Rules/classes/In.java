...
public class In extends RuntimeClassBase {

    public Object rule = "in";

    public Object values = null;

    public In(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == In.class) {
            this.__construct(env, args);
        }
    }

    public In(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Validation\\Rules\\In";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Validation\\Rules\\In")
                    .setLookup(
                            In.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("rule", "values")
                    .setFilename("vendor/laravel/framework/src/Illuminate/Validation/Rules/In.php")
                    .get();
