...
public class Else_ extends Stmt {

    public Object stmts = null;

    public Else_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Else_.class) {
            this.__construct(env, args);
        }
    }

    public Else_(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\Else_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\Else_")
                    .setLookup(
                            Else_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/Else_.php")
