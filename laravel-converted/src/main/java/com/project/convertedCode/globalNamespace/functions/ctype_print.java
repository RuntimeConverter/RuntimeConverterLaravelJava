...
public class ctype_print extends FunctionBaseRegular {

    public static ctype_print f = new ctype_print();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "text")
    public Object call(RuntimeEnv env, Object... args) {
        Object text = assignParameter(args, 0, false);
        return ZVal.assign(Ctype.runtimeStaticObject.ctype_print(env, text));
    }
