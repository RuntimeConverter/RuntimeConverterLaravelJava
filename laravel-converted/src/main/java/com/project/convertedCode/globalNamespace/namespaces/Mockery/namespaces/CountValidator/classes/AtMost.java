...
public class AtMost extends CountValidatorAbstract {

    public AtMost(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AtMost.class) {
            this.__construct(env, args);
        }
    }

    public AtMost(NoConstructor n) {
        super(n);
    }
    ...
    public Object validate(RuntimeEnv env, Object... args) {
        ...
        if (ZVal.isLessThan(toObjectR(this).accessProp(this, env).name("_limit").value(), '<', n)) {
            exception =
    ...
    public static final Object CONST_class = "Mockery\\CountValidator\\AtMost";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Mockery\\CountValidator\\AtMost")
                    .setLookup(
                            AtMost.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("_expectation", "_limit")
                    .setFilename("vendor/mockery/mockery/library/Mockery/CountValidator/AtMost.php")
