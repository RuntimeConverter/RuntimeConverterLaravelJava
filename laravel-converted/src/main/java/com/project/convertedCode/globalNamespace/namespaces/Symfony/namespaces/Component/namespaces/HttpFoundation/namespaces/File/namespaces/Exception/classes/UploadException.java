...
public class UploadException extends FileException {

    public UploadException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UploadException.class) {
            this.__construct(env, args);
        }
    }

    public UploadException(NoConstructor n) {
        super(n);
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Symfony\\Component\\HttpFoundation\\File\\Exception\\UploadException")
                    .setLookup(
