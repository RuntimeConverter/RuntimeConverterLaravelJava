...
public class Greater extends BinaryOp {
    ...
    public Greater(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Greater.class) {
            this.__construct(env, args);
        }
    }

    public Greater(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\BinaryOp\\Greater";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\BinaryOp\\Greater")
                    .setLookup(
                            Greater.class,
