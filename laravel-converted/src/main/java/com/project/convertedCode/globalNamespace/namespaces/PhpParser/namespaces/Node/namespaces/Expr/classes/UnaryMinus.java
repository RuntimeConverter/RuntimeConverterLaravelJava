...
public class UnaryMinus extends Expr {
    ...
    public UnaryMinus(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnaryMinus.class) {
            this.__construct(env, args);
        }
    }

    public UnaryMinus(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\UnaryMinus";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\UnaryMinus")
                    .setLookup(
                            UnaryMinus.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/UnaryMinus.php")
