...
public class ThrottleRequestsException extends HttpException {

    public ThrottleRequestsException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ThrottleRequestsException.class) {
            this.__construct(env, args);
        }
    }

    public ThrottleRequestsException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(env, 429, message, previous, headers, code);
        return null;
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Http\\Exceptions\\ThrottleRequestsException")
                    .setLookup(
