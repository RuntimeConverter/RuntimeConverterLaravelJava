...
public class utf8_encode extends FunctionBaseRegular {

    public static utf8_encode f = new utf8_encode();

    @ConvertedMethod
    @ConvertedParameter(index = 0, name = "s")
    public Object call(RuntimeEnv env, Object... args) {
        Object s = assignParameter(args, 0, false);
        return ZVal.assign(Php72.runtimeStaticObject.utf8_encode(env, s));
    }
