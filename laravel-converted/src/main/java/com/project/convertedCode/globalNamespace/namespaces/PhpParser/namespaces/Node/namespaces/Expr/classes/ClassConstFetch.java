...
public class ClassConstFetch extends Expr {

    public Object _pClass = null;

    public Object name = null;

    public ClassConstFetch(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ClassConstFetch.class) {
            this.__construct(env, args);
        }
    }

    public ClassConstFetch(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\ClassConstFetch";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\ClassConstFetch")
                    .setLookup(
