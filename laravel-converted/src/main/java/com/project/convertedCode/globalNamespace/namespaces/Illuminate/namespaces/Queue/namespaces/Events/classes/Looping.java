...
public class Looping extends RuntimeClassBase {

    public Object connectionName = null;

    public Object queue = null;

    public Looping(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Looping.class) {
            this.__construct(env, args);
        }
    }

    public Looping(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Illuminate\\Queue\\Events\\Looping";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Illuminate\\Queue\\Events\\Looping")
                    .setLookup(
                            Looping.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("connectionName", "queue")
                    .setFilename("vendor/laravel/framework/src/Illuminate/Queue/Events/Looping.php")
                    .get();
