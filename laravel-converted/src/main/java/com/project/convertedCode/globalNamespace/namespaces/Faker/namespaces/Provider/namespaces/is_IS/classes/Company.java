...
public class Company
    ...
    public static final Object CONST_class = "Faker\\Provider\\is_IS\\Company";
    ...
    public static class RuntimeStaticCompanion
        ...
        @ConvertedMethod
        public Object vsk(RuntimeEnv env, Object... args) {
            return ZVal.assign(
    ...
    public static class RequestStaticProperties {
        ...
        public Object companySuffix = ZVal.arrayFromList("ehf.", "hf.", "sf.");

        public Object vskFormat = "%####";
    }

    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Faker\\Provider\\is_IS\\Company")
                    .setLookup(
                            Company.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("generator", "unique")
                    .setStaticPropertyNames("companySuffix", "formats", "vskFormat")
                    .setFilename("vendor/fzaninotto/faker/src/Faker/Provider/is_IS/Company.php")
