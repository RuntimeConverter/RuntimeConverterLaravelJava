...
public class Instanceof_ extends Expr {

    public Object expr = null;

    public Object _pClass = null;

    public Instanceof_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Instanceof_.class) {
            this.__construct(env, args);
        }
    }

    public Instanceof_(NoConstructor n) {
        super(n);
    }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("expr", "class"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Expr\\Instanceof_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Expr\\Instanceof_")
                    .setLookup(
                            Instanceof_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "class", "expr")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Expr/Instanceof_.php")
