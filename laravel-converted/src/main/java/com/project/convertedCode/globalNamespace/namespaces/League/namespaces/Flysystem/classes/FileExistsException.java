...
public class FileExistsException extends Exception {
    ...
    public FileExistsException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == FileExistsException.class) {
            this.__construct(env, args);
        }
    }

    public FileExistsException(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        super.__construct(
                env,
                "File already exists at path: " + toStringR(this.getPath(env), env),
                code,
                previous);
        return null;
    }
    ...
    public static final Object CONST_class = "League\\Flysystem\\FileExistsException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("League\\Flysystem\\FileExistsException")
                    .setLookup(
                            FileExistsException.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("path")
                    .setFilename("vendor/league/flysystem/src/FileExistsException.php")
