...
public class If_ extends Stmt {

    public Object cond = null;

    public Object stmts = null;

    public Object elseifs = null;

    public Object _pElse = null;

    public If_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == If_.class) {
            this.__construct(env, args);
        }
    }

    public If_(NoConstructor n) {
        super(n);
    }
    ...
    public Object __construct(RuntimeEnv env, Object... args) {
        ...
        this.stmts =
                ZVal.isDefined(ternaryExpressionTemp = subNodes.arrayGet(env, "stmts"))
                        ...
                        : ZVal.newArray();
        this.elseifs =
                ZVal.isDefined(ternaryExpressionTemp = subNodes.arrayGet(env, "elseifs"))
                        ? ternaryExpressionTemp
                        : ZVal.newArray();
        this._pElse =
                ZVal.isDefined(ternaryExpressionTemp = subNodes.arrayGet(env, "else"))
                        ? ternaryExpressionTemp
                        : ZVal.getNull();
        return null;
    }
    ...
    public Object getSubNodeNames(RuntimeEnv env, Object... args) {
        return ZVal.assign(ZVal.arrayFromList("cond", "stmts", "elseifs", "else"));
    }
    ...
    public static final Object CONST_class = "PhpParser\\Node\\Stmt\\If_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PhpParser\\Node\\Stmt\\If_")
                    .setLookup(
                            If_.class,
                            MethodHandles.lookup(),
                            RuntimeStaticCompanion.staticCompanionLookup)
                    .setLocalProperties("attributes", "cond", "else", "elseifs", "stmts")
                    .setFilename("vendor/nikic/php-parser/lib/PhpParser/Node/Stmt/If_.php")
