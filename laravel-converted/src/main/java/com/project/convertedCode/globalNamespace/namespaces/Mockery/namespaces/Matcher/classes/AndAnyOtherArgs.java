...
public class AndAnyOtherArgs extends MatcherAbstract {

    public AndAnyOtherArgs(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == AndAnyOtherArgs.class) {
            this.__construct(env, args);
        }
    }

    public AndAnyOtherArgs(NoConstructor n) {
        super(n);
    }
    ...
    public static final Object CONST_class = "Mockery\\Matcher\\AndAnyOtherArgs";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Mockery\\Matcher\\AndAnyOtherArgs")
                    .setLookup(
                            AndAnyOtherArgs.class,
