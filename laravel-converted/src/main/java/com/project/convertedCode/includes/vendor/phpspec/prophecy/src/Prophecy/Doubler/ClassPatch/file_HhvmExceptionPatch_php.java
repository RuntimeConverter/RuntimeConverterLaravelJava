...
public class file_HhvmExceptionPatch_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2418 scope = new Scope2418();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2418 scope)
    ...
    private static class Scope2418 implements UpdateRuntimeScopeInterface {
