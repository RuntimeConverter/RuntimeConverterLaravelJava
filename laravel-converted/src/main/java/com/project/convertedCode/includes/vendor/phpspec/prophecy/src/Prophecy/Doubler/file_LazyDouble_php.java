...
public class file_LazyDouble_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2435 scope = new Scope2435();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2435 scope)
    ...
    private static class Scope2435 implements UpdateRuntimeScopeInterface {
