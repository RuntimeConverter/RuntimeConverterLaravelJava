...
public class file_Route_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3588 scope = new Scope3588();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3588 scope)
            throws IncludeEventException {

        // Conversion Note: class named Route was here in the source code
        env.addManualClassLoad("Symfony\\Component\\Routing\\Route");
    }
    ...
    private static class Scope3588 implements UpdateRuntimeScopeInterface {
