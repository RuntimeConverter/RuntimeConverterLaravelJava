...
public class file_Url_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2358 scope = new Scope2358();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2358 scope)
    ...
    private static class Scope2358 implements UpdateRuntimeScopeInterface {
