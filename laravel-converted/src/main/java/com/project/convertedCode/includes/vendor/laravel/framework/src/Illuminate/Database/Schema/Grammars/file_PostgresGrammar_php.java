...
public class file_PostgresGrammar_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1178 scope = new Scope1178();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1178 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Schema\\Grammars\\PostgresGrammar");
    }
    ...
    private static class Scope1178 implements UpdateRuntimeScopeInterface {
