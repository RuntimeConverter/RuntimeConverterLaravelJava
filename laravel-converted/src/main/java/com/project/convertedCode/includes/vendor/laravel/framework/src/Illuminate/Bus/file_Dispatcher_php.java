...
public class file_Dispatcher_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope926 scope = new Scope926();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope926 scope)
        ...
        env.addManualClassLoad("Illuminate\\Bus\\Dispatcher");
    }
    ...
    private static class Scope926 implements UpdateRuntimeScopeInterface {
