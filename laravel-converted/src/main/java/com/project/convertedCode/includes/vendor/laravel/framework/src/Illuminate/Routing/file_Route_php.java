...
public class file_Route_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1537 scope = new Scope1537();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1537 scope)
        ...
        env.addManualClassLoad("Illuminate\\Routing\\Route");
    }
    ...
    private static class Scope1537 implements UpdateRuntimeScopeInterface {
