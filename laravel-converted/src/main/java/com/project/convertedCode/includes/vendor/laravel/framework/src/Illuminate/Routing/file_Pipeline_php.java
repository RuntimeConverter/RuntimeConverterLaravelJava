...
public class file_Pipeline_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1532 scope = new Scope1532();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1532 scope)
        ...
        env.addManualClassLoad("Illuminate\\Routing\\Pipeline");
    }
    ...
    private static class Scope1532 implements UpdateRuntimeScopeInterface {
