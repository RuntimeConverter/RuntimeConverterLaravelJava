...
public class file_Dispatcher_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1191 scope = new Scope1191();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1191 scope)
        ...
        env.addManualClassLoad("Illuminate\\Events\\Dispatcher");
    }
    ...
    private static class Scope1191 implements UpdateRuntimeScopeInterface {
