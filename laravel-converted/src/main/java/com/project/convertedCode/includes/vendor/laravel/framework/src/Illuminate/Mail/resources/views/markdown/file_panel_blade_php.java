...
public class file_panel_blade_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1393 scope = new Scope1393();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1393 scope)
    ...
    private static class Scope1393 implements UpdateRuntimeScopeInterface {
