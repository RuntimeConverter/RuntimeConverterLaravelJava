...
public class file_SelfDescribing_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2645 scope = new Scope2645();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2645 scope)
    ...
    private static class Scope2645 implements UpdateRuntimeScopeInterface {
