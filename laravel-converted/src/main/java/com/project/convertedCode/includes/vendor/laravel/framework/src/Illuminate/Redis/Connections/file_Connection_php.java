...
public class file_Connection_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1498 scope = new Scope1498();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1498 scope)
        ...
        env.addManualClassLoad("Illuminate\\Redis\\Connections\\Connection");
    }
    ...
    private static class Scope1498 implements UpdateRuntimeScopeInterface {
