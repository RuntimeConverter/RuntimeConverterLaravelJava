...
public class file_Method_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2511 scope = new Scope2511();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2511 scope)
    ...
    private static class Scope2511 implements UpdateRuntimeScopeInterface {
