...
public class file_Version_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2366 scope = new Scope2366();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2366 scope)
    ...
    private static class Scope2366 implements UpdateRuntimeScopeInterface {
