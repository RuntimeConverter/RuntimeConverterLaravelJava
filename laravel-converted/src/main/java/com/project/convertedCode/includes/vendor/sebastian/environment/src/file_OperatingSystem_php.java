...
public class file_OperatingSystem_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2955 scope = new Scope2955();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2955 scope)
    ...
    private static class Scope2955 implements UpdateRuntimeScopeInterface {
