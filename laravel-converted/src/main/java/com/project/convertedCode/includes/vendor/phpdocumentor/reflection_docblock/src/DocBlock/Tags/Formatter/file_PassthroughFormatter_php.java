...
public class file_PassthroughFormatter_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2348 scope = new Scope2348();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2348 scope)
    ...
    private static class Scope2348 implements UpdateRuntimeScopeInterface {
