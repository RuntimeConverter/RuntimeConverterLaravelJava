...
public class file_UrlGenerator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1051 scope = new Scope1051();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1051 scope)
            throws IncludeEventException {

        // Conversion Note: class named UrlGenerator was here in the source code
        env.addManualClassLoad("Illuminate\\Contracts\\Routing\\UrlGenerator");
    }
    ...
    private static class Scope1051 implements UpdateRuntimeScopeInterface {
