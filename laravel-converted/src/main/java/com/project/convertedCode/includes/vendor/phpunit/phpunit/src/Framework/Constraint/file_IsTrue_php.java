...
public class file_IsTrue_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2564 scope = new Scope2564();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2564 scope)
    ...
    private static class Scope2564 implements UpdateRuntimeScopeInterface {
