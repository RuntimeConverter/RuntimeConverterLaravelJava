...
public class file_IsIdentical_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope822 scope = new Scope822();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope822 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named IsIdentical was here in the source code
        env.addManualClassLoad("Hamcrest\\Core\\IsIdentical");
    }
    ...
    private static class Scope822 implements UpdateRuntimeScopeInterface {
