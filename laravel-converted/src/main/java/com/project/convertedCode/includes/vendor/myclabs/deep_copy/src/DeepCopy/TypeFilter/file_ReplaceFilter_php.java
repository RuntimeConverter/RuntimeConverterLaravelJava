...
public class file_ReplaceFilter_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1941 scope = new Scope1941();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1941 scope)
    ...
    private static class Scope1941 implements UpdateRuntimeScopeInterface {
