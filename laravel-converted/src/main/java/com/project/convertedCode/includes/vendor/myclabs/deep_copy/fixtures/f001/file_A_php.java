...
public class file_A_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1912 scope = new Scope1912();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1912 scope)
    ...
    private static class Scope1912 implements UpdateRuntimeScopeInterface {
