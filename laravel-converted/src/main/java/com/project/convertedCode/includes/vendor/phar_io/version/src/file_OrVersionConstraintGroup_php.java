...
public class file_OrVersionConstraintGroup_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2315 scope = new Scope2315();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2315 scope)
    ...
    private static class Scope2315 implements UpdateRuntimeScopeInterface {
