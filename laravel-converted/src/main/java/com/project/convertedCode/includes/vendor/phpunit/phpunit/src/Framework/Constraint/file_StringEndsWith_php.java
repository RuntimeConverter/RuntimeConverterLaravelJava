...
public class file_StringEndsWith_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2578 scope = new Scope2578();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2578 scope)
    ...
    private static class Scope2578 implements UpdateRuntimeScopeInterface {
