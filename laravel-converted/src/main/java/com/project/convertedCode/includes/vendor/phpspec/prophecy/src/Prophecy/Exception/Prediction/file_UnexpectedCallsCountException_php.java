...
public class file_UnexpectedCallsCountException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2453 scope = new Scope2453();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2453 scope)
    ...
    private static class Scope2453 implements UpdateRuntimeScopeInterface {
