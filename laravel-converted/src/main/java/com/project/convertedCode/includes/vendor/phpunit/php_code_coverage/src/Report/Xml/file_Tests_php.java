...
public class file_Tests_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2516 scope = new Scope2516();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2516 scope)
    ...
    private static class Scope2516 implements UpdateRuntimeScopeInterface {
