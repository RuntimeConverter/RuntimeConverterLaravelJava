...
public class file_Totals_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2517 scope = new Scope2517();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2517 scope)
    ...
    private static class Scope2517 implements UpdateRuntimeScopeInterface {
