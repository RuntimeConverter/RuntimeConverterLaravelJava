...
public class file_random_bytes_com_dotnet_php implements RuntimeIncludable {

    public static final file_random_bytes_com_dotnet_php instance =
            new file_random_bytes_com_dotnet_php();

    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2250 scope = new Scope2250();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2250 scope)
    ...
    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    ...
                    .setFile("/vendor/paragonie/random_compat/lib/random_bytes_com_dotnet.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope2250 implements UpdateRuntimeScopeInterface {
