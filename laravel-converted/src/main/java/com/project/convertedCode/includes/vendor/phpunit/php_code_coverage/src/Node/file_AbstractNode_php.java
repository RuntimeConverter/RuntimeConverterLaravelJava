...
public class file_AbstractNode_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2492 scope = new Scope2492();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2492 scope)
    ...
    private static class Scope2492 implements UpdateRuntimeScopeInterface {
