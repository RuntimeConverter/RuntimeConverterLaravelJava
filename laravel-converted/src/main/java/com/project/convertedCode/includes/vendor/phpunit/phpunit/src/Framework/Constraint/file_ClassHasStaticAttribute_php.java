...
public class file_ClassHasStaticAttribute_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2541 scope = new Scope2541();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2541 scope)
    ...
    private static class Scope2541 implements UpdateRuntimeScopeInterface {
