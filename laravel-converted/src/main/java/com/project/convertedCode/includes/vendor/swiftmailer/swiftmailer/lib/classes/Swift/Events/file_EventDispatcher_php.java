...
public class file_EventDispatcher_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3006 scope = new Scope3006();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3006 scope)
            throws IncludeEventException {
        // Conversion Note: class named Swift_Events_EventDispatcher was here in the source code
        env.addManualClassLoad("Swift_Events_EventDispatcher");
    }
    ...
    private static class Scope3006 implements UpdateRuntimeScopeInterface {
