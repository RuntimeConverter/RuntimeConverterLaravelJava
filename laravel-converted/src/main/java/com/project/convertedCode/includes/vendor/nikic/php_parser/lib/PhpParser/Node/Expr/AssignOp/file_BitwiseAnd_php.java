...
public class file_BitwiseAnd_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2057 scope = new Scope2057();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2057 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named BitwiseAnd was here in the source code
        env.addManualClassLoad("PhpParser\\Node\\Expr\\AssignOp\\BitwiseAnd");
    }
    ...
    private static class Scope2057 implements UpdateRuntimeScopeInterface {
