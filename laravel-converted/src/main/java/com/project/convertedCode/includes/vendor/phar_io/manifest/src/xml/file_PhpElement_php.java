...
public class file_PhpElement_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2306 scope = new Scope2306();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2306 scope)
    ...
    private static class Scope2306 implements UpdateRuntimeScopeInterface {
