...
public class file_RuntimeException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2489 scope = new Scope2489();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2489 scope)
    ...
    private static class Scope2489 implements UpdateRuntimeScopeInterface {
