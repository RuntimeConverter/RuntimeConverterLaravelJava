...
public class file_message_blade_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1382 scope = new Scope1382();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1382 scope)
    ...
    private static class Scope1382 implements UpdateRuntimeScopeInterface {
