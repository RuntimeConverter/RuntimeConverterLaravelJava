...
public class file_LicenseElement_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2302 scope = new Scope2302();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2302 scope)
    ...
    private static class Scope2302 implements UpdateRuntimeScopeInterface {
