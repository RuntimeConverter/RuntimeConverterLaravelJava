...
public class file_random_bytes_libsodium_php implements RuntimeIncludable {

    public static final file_random_bytes_libsodium_php instance =
            new file_random_bytes_libsodium_php();

    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2252 scope = new Scope2252();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2252 scope)
    ...
    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    ...
                    .setFile("/vendor/paragonie/random_compat/lib/random_bytes_libsodium.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope2252 implements UpdateRuntimeScopeInterface {
