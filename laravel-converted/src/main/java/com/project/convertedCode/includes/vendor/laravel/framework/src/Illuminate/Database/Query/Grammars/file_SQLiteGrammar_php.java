...
public class file_SQLiteGrammar_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1162 scope = new Scope1162();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1162 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Query\\Grammars\\SQLiteGrammar");
    }
    ...
    private static class Scope1162 implements UpdateRuntimeScopeInterface {
