...
public class file_LoadBalancedTransport_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3032 scope = new Scope3032();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3032 scope)
            throws IncludeEventException {
        // Conversion Note: class named Swift_LoadBalancedTransport was here in the source code
        env.addManualClassLoad("Swift_LoadBalancedTransport");
    }
    ...
    private static class Scope3032 implements UpdateRuntimeScopeInterface {
