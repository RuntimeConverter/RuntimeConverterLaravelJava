...
public class file_SendmailTransport_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3128 scope = new Scope3128();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3128 scope)
            throws IncludeEventException {
        // Conversion Note: class named Swift_Transport_SendmailTransport was here in the source
        // code
        env.addManualClassLoad("Swift_Transport_SendmailTransport");
    }
    ...
    private static class Scope3128 implements UpdateRuntimeScopeInterface {
