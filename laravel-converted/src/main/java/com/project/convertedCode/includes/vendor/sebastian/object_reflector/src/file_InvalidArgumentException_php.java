...
public class file_InvalidArgumentException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2968 scope = new Scope2968();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2968 scope)
    ...
    private static class Scope2968 implements UpdateRuntimeScopeInterface {
