...
public class file_String__php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2390 scope = new Scope2390();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2390 scope)
    ...
    private static class Scope2390 implements UpdateRuntimeScopeInterface {
