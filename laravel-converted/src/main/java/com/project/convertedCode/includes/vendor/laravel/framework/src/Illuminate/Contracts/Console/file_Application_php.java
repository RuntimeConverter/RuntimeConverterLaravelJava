...
public class file_Application_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1007 scope = new Scope1007();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1007 scope)
            throws IncludeEventException {

        // Conversion Note: class named Application was here in the source code
        env.addManualClassLoad("Illuminate\\Contracts\\Console\\Application");
    }
    ...
    private static class Scope1007 implements UpdateRuntimeScopeInterface {
