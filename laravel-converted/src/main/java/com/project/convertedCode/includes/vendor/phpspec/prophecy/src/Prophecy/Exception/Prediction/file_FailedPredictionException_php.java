...
public class file_FailedPredictionException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2450 scope = new Scope2450();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2450 scope)
    ...
    private static class Scope2450 implements UpdateRuntimeScopeInterface {
