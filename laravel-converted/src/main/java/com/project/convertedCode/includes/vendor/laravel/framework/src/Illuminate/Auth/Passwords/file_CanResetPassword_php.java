...
public class file_CanResetPassword_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope900 scope = new Scope900();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope900 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named CanResetPassword was here in the source code
        env.addManualClassLoad("Illuminate\\Auth\\Passwords\\CanResetPassword");
    }
    ...
    private static class Scope900 implements UpdateRuntimeScopeInterface {
