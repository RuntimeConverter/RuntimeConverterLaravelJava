...
public class file_Integer_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2379 scope = new Scope2379();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2379 scope)
    ...
    private static class Scope2379 implements UpdateRuntimeScopeInterface {
