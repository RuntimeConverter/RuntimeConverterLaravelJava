...
public class file_Constraint_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2543 scope = new Scope2543();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2543 scope)
    ...
    private static class Scope2543 implements UpdateRuntimeScopeInterface {
