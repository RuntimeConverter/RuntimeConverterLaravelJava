...
public class file_Param_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2352 scope = new Scope2352();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2352 scope)
    ...
    private static class Scope2352 implements UpdateRuntimeScopeInterface {
