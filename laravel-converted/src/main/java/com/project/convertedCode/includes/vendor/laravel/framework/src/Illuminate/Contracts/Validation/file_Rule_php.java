...
public class file_Rule_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1065 scope = new Scope1065();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1065 scope)
            throws IncludeEventException {

        // Conversion Note: class named Rule was here in the source code
        env.addManualClassLoad("Illuminate\\Contracts\\Validation\\Rule");
    }
    ...
    private static class Scope1065 implements UpdateRuntimeScopeInterface {
