...
public class file_sr_Cyrl_ME_php implements RuntimeIncludable {

    public static final file_sr_Cyrl_ME_php instance = new file_sr_Cyrl_ME_php();

    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2004 scope = new Scope2004();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2004 scope)
        ...
        throw new IncludeEventException(
                ZVal.assign(
                        ZVal.newArray(
                                ...
                                new ZPair(
                                        "month",
                                        "{1} :count \u043C\u0458\u0435\u0441\u0435\u0446|{2,3,4}:count \u043C\u0458\u0435\u0441\u0435\u0446\u0430|[5,Inf[ :count \u043C\u0458\u0435\u0441\u0435\u0446\u0438"),
                                new ZPair("m", ":count \u043C\u0458."),
                                new ZPair(
                                        "week",
                                        "{1} :count \u043D\u0435\u0434\u0458\u0435\u0459\u0430|{2,3,4}:count \u043D\u0435\u0434\u0458\u0435\u0459\u0435|[5,Inf[ :count \u043D\u0435\u0434\u0458\u0435\u0459\u0430"),
                                ...
                                new ZPair(
                                        "week_from_now",
                                        "{1} :count \u043D\u0435\u0434\u0458\u0435\u0459\u0443|{2,3,4} :count \u043D\u0435\u0434\u0458\u0435\u0459\u0435|[5,Inf[ :count \u043D\u0435\u0434\u0458\u0435\u0459\u0430"),
                                new ZPair(
                                        "week_ago",
                                        "{1} :count \u043D\u0435\u0434\u0458\u0435\u0459\u0443|{2,3,4} :count \u043D\u0435\u0434\u0458\u0435\u0459\u0435|[5,Inf[ :count \u043D\u0435\u0434\u0458\u0435\u0459\u0430"))));
    }
    ...
    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    ...
                    .setFile("/vendor/nesbot/carbon/src/Carbon/Lang/sr_Cyrl_ME.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope2004 implements UpdateRuntimeScopeInterface {
