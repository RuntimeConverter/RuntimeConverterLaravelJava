...
public class file_Property_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2353 scope = new Scope2353();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2353 scope)
    ...
    private static class Scope2353 implements UpdateRuntimeScopeInterface {
