...
public class file_Factory_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1115 scope = new Scope1115();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1115 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Eloquent\\Factory");
    }
    ...
    private static class Scope1115 implements UpdateRuntimeScopeInterface {
