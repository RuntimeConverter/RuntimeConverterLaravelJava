...
public class file_Compound_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2375 scope = new Scope2375();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2375 scope)
    ...
    private static class Scope2375 implements UpdateRuntimeScopeInterface {
