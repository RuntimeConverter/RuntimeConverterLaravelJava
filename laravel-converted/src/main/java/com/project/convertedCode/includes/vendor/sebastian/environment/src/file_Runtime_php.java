...
public class file_Runtime_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2956 scope = new Scope2956();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2956 scope)
    ...
    private static class Scope2956 implements UpdateRuntimeScopeInterface {
