...
public class file_Node_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2512 scope = new Scope2512();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2512 scope)
    ...
    private static class Scope2512 implements UpdateRuntimeScopeInterface {
