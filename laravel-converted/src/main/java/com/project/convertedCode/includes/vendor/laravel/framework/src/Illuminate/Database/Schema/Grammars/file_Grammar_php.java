...
public class file_Grammar_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1176 scope = new Scope1176();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1176 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Schema\\Grammars\\Grammar");
    }
    ...
    private static class Scope1176 implements UpdateRuntimeScopeInterface {
