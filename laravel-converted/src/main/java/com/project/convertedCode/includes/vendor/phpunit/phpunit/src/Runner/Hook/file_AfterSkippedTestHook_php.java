...
public class file_AfterSkippedTestHook_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2672 scope = new Scope2672();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2672 scope)
    ...
    private static class Scope2672 implements UpdateRuntimeScopeInterface {
