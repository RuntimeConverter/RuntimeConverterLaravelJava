...
public class file_AccessDeniedException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3321 scope = new Scope3321();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3321 scope)
    ...
    private static class Scope3321 implements UpdateRuntimeScopeInterface {
