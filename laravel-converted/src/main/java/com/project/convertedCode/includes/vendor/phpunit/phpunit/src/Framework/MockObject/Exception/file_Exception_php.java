...
public class file_Exception_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2605 scope = new Scope2605();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2605 scope)
    ...
    private static class Scope2605 implements UpdateRuntimeScopeInterface {
