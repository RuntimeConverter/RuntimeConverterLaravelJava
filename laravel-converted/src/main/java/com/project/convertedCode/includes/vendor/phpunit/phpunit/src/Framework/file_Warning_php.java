...
public class file_Warning_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2660 scope = new Scope2660();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2660 scope)
    ...
    private static class Scope2660 implements UpdateRuntimeScopeInterface {
