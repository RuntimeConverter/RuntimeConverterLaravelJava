...
public class file_Hub_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1034 scope = new Scope1034();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1034 scope)
            throws IncludeEventException {

        // Conversion Note: class named Hub was here in the source code
        env.addManualClassLoad("Illuminate\\Contracts\\Pipeline\\Hub");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/laravel/framework/src/Illuminate/Contracts/Pipeline")
                    .setFile("/vendor/laravel/framework/src/Illuminate/Contracts/Pipeline/Hub.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope1034 implements UpdateRuntimeScopeInterface {
