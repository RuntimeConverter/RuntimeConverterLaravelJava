...
public class file_IsInstanceOf_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2559 scope = new Scope2559();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2559 scope)
    ...
    private static class Scope2559 implements UpdateRuntimeScopeInterface {
