...
public class file_LessThan_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2569 scope = new Scope2569();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2569 scope)
    ...
    private static class Scope2569 implements UpdateRuntimeScopeInterface {
