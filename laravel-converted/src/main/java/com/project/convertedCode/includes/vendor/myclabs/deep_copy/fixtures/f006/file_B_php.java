...
public class file_B_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1919 scope = new Scope1919();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1919 scope)
    ...
    private static class Scope1919 implements UpdateRuntimeScopeInterface {
