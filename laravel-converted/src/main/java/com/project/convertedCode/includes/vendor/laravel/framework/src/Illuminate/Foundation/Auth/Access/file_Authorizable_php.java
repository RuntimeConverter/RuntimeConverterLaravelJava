...
public class file_Authorizable_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1200 scope = new Scope1200();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1200 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named Authorizable was here in the source code
        env.addManualClassLoad("Illuminate\\Foundation\\Auth\\Access\\Authorizable");
    }
    ...
    private static class Scope1200 implements UpdateRuntimeScopeInterface {
