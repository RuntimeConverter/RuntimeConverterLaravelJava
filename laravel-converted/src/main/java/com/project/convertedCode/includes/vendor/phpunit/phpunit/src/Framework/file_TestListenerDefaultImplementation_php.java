...
public class file_TestListenerDefaultImplementation_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2655 scope = new Scope2655();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2655 scope)
    ...
    private static class Scope2655 implements UpdateRuntimeScopeInterface {
