...
public class file_UploadedFile_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3342 scope = new Scope3342();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3342 scope)
        ...
        env.addManualClassLoad("Symfony\\Component\\HttpFoundation\\File\\UploadedFile");
    }
    ...
    private static class Scope3342 implements UpdateRuntimeScopeInterface {
