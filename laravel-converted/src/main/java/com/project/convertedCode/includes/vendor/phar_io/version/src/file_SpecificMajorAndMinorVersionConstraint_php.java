...
public class file_SpecificMajorAndMinorVersionConstraint_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2317 scope = new Scope2317();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2317 scope)
    ...
    private static class Scope2317 implements UpdateRuntimeScopeInterface {
