...
public class file_StatelessInvocation_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2628 scope = new Scope2628();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2628 scope)
    ...
    private static class Scope2628 implements UpdateRuntimeScopeInterface {
