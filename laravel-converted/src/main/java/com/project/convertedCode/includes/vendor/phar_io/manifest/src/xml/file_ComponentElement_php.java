...
public class file_ComponentElement_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2294 scope = new Scope2294();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2294 scope)
    ...
    private static class Scope2294 implements UpdateRuntimeScopeInterface {
