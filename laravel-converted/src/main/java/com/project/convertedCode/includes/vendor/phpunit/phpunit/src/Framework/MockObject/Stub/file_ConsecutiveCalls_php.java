...
public class file_ConsecutiveCalls_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2632 scope = new Scope2632();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2632 scope)
    ...
    private static class Scope2632 implements UpdateRuntimeScopeInterface {
