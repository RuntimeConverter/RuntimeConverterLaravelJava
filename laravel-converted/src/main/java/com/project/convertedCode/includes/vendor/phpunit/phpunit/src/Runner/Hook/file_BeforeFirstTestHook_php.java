...
public class file_BeforeFirstTestHook_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2677 scope = new Scope2677();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2677 scope)
    ...
    private static class Scope2677 implements UpdateRuntimeScopeInterface {
