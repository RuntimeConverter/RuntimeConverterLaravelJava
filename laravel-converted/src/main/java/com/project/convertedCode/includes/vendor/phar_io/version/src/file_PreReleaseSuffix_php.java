...
public class file_PreReleaseSuffix_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2316 scope = new Scope2316();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2316 scope)
    ...
    private static class Scope2316 implements UpdateRuntimeScopeInterface {
