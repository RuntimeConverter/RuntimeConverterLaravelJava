...
public class file_table_blade_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1387 scope = new Scope1387();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1387 scope)
            throws IncludeEventException {
        env.echo("<div class=\"table\">\n{{ Illuminate\\Mail\\Markdown::parse($slot) }}\n</div>\n");
    }
    ...
    private static class Scope1387 implements UpdateRuntimeScopeInterface {
