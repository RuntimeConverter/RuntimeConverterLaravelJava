...
public class file_Lorem_php implements RuntimeIncludable {

    public static final file_Lorem_php instance = new file_Lorem_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope389 scope)
        ...
        // Conversion Note: class named Lorem was here in the source code
        env.addManualClassLoad("Faker\\Provider\\Lorem");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/fzaninotto/faker/src/Faker/Provider")
                    .setFile("/vendor/fzaninotto/faker/src/Faker/Provider/Lorem.php");
