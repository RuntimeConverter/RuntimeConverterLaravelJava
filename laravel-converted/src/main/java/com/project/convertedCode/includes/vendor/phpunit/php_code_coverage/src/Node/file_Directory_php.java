...
public class file_Directory_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2494 scope = new Scope2494();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2494 scope)
    ...
    private static class Scope2494 implements UpdateRuntimeScopeInterface {
