...
public class file_ArrayComparator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2923 scope = new Scope2923();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2923 scope)
    ...
    private static class Scope2923 implements UpdateRuntimeScopeInterface {
