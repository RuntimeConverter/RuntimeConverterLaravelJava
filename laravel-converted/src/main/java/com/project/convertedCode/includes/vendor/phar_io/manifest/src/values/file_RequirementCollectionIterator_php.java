...
public class file_RequirementCollectionIterator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2288 scope = new Scope2288();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2288 scope)
    ...
    private static class Scope2288 implements UpdateRuntimeScopeInterface {
