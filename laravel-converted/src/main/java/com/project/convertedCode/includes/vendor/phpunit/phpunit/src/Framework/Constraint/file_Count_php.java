...
public class file_Count_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2544 scope = new Scope2544();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2544 scope)
    ...
    private static class Scope2544 implements UpdateRuntimeScopeInterface {
