...
public class file_ExtElement_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2299 scope = new Scope2299();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2299 scope)
    ...
    private static class Scope2299 implements UpdateRuntimeScopeInterface {
