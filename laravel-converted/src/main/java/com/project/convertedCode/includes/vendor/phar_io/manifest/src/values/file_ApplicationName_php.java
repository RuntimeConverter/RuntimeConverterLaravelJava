...
public class file_ApplicationName_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2271 scope = new Scope2271();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2271 scope)
    ...
    private static class Scope2271 implements UpdateRuntimeScopeInterface {
