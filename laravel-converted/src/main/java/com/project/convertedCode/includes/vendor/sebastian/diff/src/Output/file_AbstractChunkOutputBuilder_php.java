...
public class file_AbstractChunkOutputBuilder_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2947 scope = new Scope2947();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2947 scope)
    ...
    private static class Scope2947 implements UpdateRuntimeScopeInterface {
