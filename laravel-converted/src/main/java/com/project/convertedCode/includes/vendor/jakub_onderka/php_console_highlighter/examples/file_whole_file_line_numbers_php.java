...
public class file_whole_file_line_numbers_php implements RuntimeIncludable {

    public static final file_whole_file_line_numbers_php instance =
            new file_whole_file_line_numbers_php();

    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope871 scope = new Scope871();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope871 scope)
        ...
        env.echo(
                env.callMethod(
                        ...
                        file_whole_file_line_numbers_php.class,
                        scope.fileContent));
    }
    ...
    private static class Scope871 implements UpdateRuntimeScopeInterface {
