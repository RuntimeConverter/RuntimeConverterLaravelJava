...
public class file_Invocation_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2619 scope = new Scope2619();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2619 scope)
    ...
    private static class Scope2619 implements UpdateRuntimeScopeInterface {
