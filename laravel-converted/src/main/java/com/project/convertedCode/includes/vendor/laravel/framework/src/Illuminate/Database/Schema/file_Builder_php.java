...
public class file_Builder_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1174 scope = new Scope1174();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1174 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Schema\\Builder");
    }
    ...
    private static class Scope1174 implements UpdateRuntimeScopeInterface {
