...
public class file_TraversablePatch_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2424 scope = new Scope2424();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2424 scope)
    ...
    private static class Scope2424 implements UpdateRuntimeScopeInterface {
