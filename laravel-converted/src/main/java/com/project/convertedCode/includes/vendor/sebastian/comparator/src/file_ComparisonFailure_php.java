...
public class file_ComparisonFailure_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2925 scope = new Scope2925();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2925 scope)
    ...
    private static class Scope2925 implements UpdateRuntimeScopeInterface {
