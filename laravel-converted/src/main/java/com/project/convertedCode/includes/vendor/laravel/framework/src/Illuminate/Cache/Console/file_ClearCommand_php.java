...
public class file_ClearCommand_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope934 scope = new Scope934();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope934 scope)
        ...
        env.addManualClassLoad("Illuminate\\Cache\\Console\\ClearCommand");
    }
    ...
    private static class Scope934 implements UpdateRuntimeScopeInterface {
