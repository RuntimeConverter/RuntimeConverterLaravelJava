...
public class file_MessageSelector_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1634 scope = new Scope1634();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1634 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named MessageSelector was here in the source code
        env.addManualClassLoad("Illuminate\\Translation\\MessageSelector");
    }
    ...
    private static class Scope1634 implements UpdateRuntimeScopeInterface {
