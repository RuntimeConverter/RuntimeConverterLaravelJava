...
public class file_DoubleException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2441 scope = new Scope2441();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2441 scope)
    ...
    private static class Scope2441 implements UpdateRuntimeScopeInterface {
