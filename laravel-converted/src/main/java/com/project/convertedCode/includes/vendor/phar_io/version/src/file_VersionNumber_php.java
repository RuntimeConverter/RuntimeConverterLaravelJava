...
public class file_VersionNumber_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2324 scope = new Scope2324();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2324 scope)
    ...
    private static class Scope2324 implements UpdateRuntimeScopeInterface {
