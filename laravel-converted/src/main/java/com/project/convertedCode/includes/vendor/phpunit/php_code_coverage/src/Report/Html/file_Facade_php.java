...
public class file_Facade_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2499 scope = new Scope2499();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2499 scope)
    ...
    private static class Scope2499 implements UpdateRuntimeScopeInterface {
