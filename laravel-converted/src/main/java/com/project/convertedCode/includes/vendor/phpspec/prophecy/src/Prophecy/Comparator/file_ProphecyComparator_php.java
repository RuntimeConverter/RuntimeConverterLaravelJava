...
public class file_ProphecyComparator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2414 scope = new Scope2414();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2414 scope)
    ...
    private static class Scope2414 implements UpdateRuntimeScopeInterface {
