...
public class file_Biased_php implements RuntimeIncludable {

    public static final file_Biased_php instance = new file_Biased_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope381 scope)
        ...
        // Conversion Note: class named Biased was here in the source code
        env.addManualClassLoad("Faker\\Provider\\Biased");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/fzaninotto/faker/src/Faker/Provider")
                    .setFile("/vendor/fzaninotto/faker/src/Faker/Provider/Biased.php");
