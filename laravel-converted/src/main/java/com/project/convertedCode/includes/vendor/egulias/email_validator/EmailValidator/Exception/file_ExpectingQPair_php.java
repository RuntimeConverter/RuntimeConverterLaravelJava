...
public class file_ExpectingQPair_php implements RuntimeIncludable {

    public static final file_ExpectingQPair_php instance = new file_ExpectingQPair_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope274 scope)
        ...
        // Conversion Note: class named ExpectedQPair was here in the source code
        env.addManualClassLoad("Egulias\\EmailValidator\\Exception\\ExpectedQPair");
    }
