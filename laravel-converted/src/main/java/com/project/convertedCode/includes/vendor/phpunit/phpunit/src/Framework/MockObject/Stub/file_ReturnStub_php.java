...
public class file_ReturnStub_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2639 scope = new Scope2639();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2639 scope)
    ...
    private static class Scope2639 implements UpdateRuntimeScopeInterface {
