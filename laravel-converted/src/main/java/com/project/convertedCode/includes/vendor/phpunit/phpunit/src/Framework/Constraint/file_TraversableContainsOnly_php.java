...
public class file_TraversableContainsOnly_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2582 scope = new Scope2582();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2582 scope)
    ...
    private static class Scope2582 implements UpdateRuntimeScopeInterface {
