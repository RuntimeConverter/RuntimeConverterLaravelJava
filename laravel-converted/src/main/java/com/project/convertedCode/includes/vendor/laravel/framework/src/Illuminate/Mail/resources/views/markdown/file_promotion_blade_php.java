...
public class file_promotion_blade_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1394 scope = new Scope1394();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1394 scope)
    ...
    private static class Scope1394 implements UpdateRuntimeScopeInterface {
