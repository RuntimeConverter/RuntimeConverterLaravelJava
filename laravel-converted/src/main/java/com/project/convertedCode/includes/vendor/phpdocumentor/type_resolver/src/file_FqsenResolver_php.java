...
public class file_FqsenResolver_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2369 scope = new Scope2369();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2369 scope)
    ...
    private static class Scope2369 implements UpdateRuntimeScopeInterface {
