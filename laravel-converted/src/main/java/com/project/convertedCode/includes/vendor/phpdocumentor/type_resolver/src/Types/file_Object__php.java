...
public class file_Object__php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2384 scope = new Scope2384();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2384 scope)
    ...
    private static class Scope2384 implements UpdateRuntimeScopeInterface {
