...
public class file_TokenStream_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2043 scope = new Scope2043();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2043 scope)
            throws IncludeEventException {

        // Conversion Note: class named TokenStream was here in the source code
        env.addManualClassLoad("PhpParser\\Internal\\TokenStream");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/nikic/php-parser/lib/PhpParser/Internal")
                    .setFile("/vendor/nikic/php-parser/lib/PhpParser/Internal/TokenStream.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope2043 implements UpdateRuntimeScopeInterface {
