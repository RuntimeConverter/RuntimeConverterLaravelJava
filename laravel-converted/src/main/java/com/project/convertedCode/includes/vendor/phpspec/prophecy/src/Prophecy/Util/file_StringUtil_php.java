...
public class file_StringUtil_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2480 scope = new Scope2480();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2480 scope)
    ...
    private static class Scope2480 implements UpdateRuntimeScopeInterface {
