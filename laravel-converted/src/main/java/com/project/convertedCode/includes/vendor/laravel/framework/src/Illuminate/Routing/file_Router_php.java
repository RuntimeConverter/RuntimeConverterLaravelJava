...
public class file_Router_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1548 scope = new Scope1548();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1548 scope)
        ...
        env.addManualClassLoad("Illuminate\\Routing\\Router");
    }
    ...
    private static class Scope1548 implements UpdateRuntimeScopeInterface {
