...
public class file_ResponseListener_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3010 scope = new Scope3010();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3010 scope)
            throws IncludeEventException {
        // Conversion Note: class named Swift_Events_ResponseListener was here in the source code
        env.addManualClassLoad("Swift_Events_ResponseListener");
    }
    ...
    private static class Scope3010 implements UpdateRuntimeScopeInterface {
