...
public class file_Attachment_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope3038 scope = new Scope3038();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope3038 scope)
            throws IncludeEventException {
        // Conversion Note: class named Swift_Mime_Attachment was here in the source code
        env.addManualClassLoad("Swift_Mime_Attachment");
    }
    ...
    private static class Scope3038 implements UpdateRuntimeScopeInterface {
