...
public class file_Util_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1740 scope = new Scope1740();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1740 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Namespace import was here
        // Conversion Note: class named Util was here in the source code
        env.addManualClassLoad("League\\Flysystem\\Util");
    }
    ...
    private static class Scope1740 implements UpdateRuntimeScopeInterface {
