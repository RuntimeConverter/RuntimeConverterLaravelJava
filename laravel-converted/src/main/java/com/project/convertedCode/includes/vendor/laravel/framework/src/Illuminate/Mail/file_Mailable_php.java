...
public class file_Mailable_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1364 scope = new Scope1364();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1364 scope)
        ...
        env.addManualClassLoad("Illuminate\\Mail\\Mailable");
    }
    ...
    private static class Scope1364 implements UpdateRuntimeScopeInterface {
