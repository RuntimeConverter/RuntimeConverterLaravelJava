...
public class file_eval_stdin_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2706 scope = new Scope2706();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2706 scope)
    ...
    private static class Scope2706 implements UpdateRuntimeScopeInterface {
