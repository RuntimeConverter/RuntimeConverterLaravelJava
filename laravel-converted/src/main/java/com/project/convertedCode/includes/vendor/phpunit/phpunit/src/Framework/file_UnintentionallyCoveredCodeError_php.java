...
public class file_UnintentionallyCoveredCodeError_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2659 scope = new Scope2659();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2659 scope)
    ...
    private static class Scope2659 implements UpdateRuntimeScopeInterface {
