...
public class file_ManifestDocument_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2303 scope = new Scope2303();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2303 scope)
    ...
    private static class Scope2303 implements UpdateRuntimeScopeInterface {
