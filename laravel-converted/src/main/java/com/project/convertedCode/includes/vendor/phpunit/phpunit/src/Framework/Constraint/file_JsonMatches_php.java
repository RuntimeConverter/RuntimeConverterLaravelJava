...
public class file_JsonMatches_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2567 scope = new Scope2567();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2567 scope)
    ...
    private static class Scope2567 implements UpdateRuntimeScopeInterface {
