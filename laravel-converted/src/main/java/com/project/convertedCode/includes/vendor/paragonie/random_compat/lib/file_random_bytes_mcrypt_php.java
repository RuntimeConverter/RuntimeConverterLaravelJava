...
public class file_random_bytes_mcrypt_php implements RuntimeIncludable {

    public static final file_random_bytes_mcrypt_php instance = new file_random_bytes_mcrypt_php();

    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2254 scope = new Scope2254();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2254 scope)
    ...
    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    ...
                    .setFile("/vendor/paragonie/random_compat/lib/random_bytes_mcrypt.php");

    public ContextConstants getContextConstants() {
        return runtimeConverterContextContantsInstance;
    }

    private static class Scope2254 implements UpdateRuntimeScopeInterface {
