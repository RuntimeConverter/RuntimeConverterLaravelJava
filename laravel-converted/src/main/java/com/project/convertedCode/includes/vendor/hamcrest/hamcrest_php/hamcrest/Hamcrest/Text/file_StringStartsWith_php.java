...
public class file_StringStartsWith_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope850 scope = new Scope850();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope850 scope)
            throws IncludeEventException {

        // Conversion Note: class named StringStartsWith was here in the source code
        env.addManualClassLoad("Hamcrest\\Text\\StringStartsWith");
    }
    ...
    private static class Scope850 implements UpdateRuntimeScopeInterface {
