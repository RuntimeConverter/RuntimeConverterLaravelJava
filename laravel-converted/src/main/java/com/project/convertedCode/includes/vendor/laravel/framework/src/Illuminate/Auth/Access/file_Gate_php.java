...
public class file_Gate_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope874 scope = new Scope874();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope874 scope)
        ...
        env.addManualClassLoad("Illuminate\\Auth\\Access\\Gate");
    }
    ...
    private static class Scope874 implements UpdateRuntimeScopeInterface {
