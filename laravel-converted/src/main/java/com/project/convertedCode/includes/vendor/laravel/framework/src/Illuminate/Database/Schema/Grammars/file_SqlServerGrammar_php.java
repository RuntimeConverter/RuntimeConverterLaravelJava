...
public class file_SqlServerGrammar_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1181 scope = new Scope1181();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1181 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Namespace import was here
        // Conversion Note: class named SqlServerGrammar was here in the source code
        env.addManualClassLoad("Illuminate\\Database\\Schema\\Grammars\\SqlServerGrammar");
    }
    ...
    private static class Scope1181 implements UpdateRuntimeScopeInterface {
