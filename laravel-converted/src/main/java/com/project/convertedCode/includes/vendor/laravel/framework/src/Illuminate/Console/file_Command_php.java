...
public class file_Command_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope959 scope = new Scope959();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope959 scope)
        ...
        env.addManualClassLoad("Illuminate\\Console\\Command");
    }
    ...
    private static class Scope959 implements UpdateRuntimeScopeInterface {
