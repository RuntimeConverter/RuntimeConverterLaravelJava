...
public class file_File_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2510 scope = new Scope2510();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2510 scope)
    ...
    private static class Scope2510 implements UpdateRuntimeScopeInterface {
