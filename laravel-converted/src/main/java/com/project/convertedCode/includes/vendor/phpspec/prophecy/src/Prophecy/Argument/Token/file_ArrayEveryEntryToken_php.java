...
public class file_ArrayEveryEntryToken_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2400 scope = new Scope2400();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2400 scope)
    ...
    private static class Scope2400 implements UpdateRuntimeScopeInterface {
