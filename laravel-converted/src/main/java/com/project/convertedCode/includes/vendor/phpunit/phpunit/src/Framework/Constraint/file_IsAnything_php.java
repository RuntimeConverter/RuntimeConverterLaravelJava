...
public class file_IsAnything_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2552 scope = new Scope2552();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2552 scope)
    ...
    private static class Scope2552 implements UpdateRuntimeScopeInterface {
