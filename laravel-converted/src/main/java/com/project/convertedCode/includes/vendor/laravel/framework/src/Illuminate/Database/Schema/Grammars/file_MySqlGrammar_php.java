...
public class file_MySqlGrammar_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1177 scope = new Scope1177();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1177 scope)
        ...
        env.addManualClassLoad("Illuminate\\Database\\Schema\\Grammars\\MySqlGrammar");
    }
    ...
    private static class Scope1177 implements UpdateRuntimeScopeInterface {
