...
public class file_Doubler_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2426 scope = new Scope2426();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2426 scope)
    ...
    private static class Scope2426 implements UpdateRuntimeScopeInterface {
