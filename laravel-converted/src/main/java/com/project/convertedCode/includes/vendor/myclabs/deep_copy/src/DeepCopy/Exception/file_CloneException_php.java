...
public class file_CloneException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1925 scope = new Scope1925();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1925 scope)
    ...
    private static class Scope1925 implements UpdateRuntimeScopeInterface {
