...
public class file_ReturnArgumentPromise_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2469 scope = new Scope2469();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2469 scope)
    ...
    private static class Scope2469 implements UpdateRuntimeScopeInterface {
