...
public class file_Broadcaster_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope915 scope = new Scope915();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope915 scope)
        ...
        env.addManualClassLoad("Illuminate\\Broadcasting\\Broadcasters\\Broadcaster");
    }
    ...
    private static class Scope915 implements UpdateRuntimeScopeInterface {
