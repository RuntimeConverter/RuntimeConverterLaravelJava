...
public class file_AfterRiskyTestHook_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2671 scope = new Scope2671();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2671 scope)
    ...
    private static class Scope2671 implements UpdateRuntimeScopeInterface {
