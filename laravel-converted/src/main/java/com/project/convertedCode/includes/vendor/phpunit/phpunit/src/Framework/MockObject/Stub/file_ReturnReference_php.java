...
public class file_ReturnReference_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2637 scope = new Scope2637();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2637 scope)
    ...
    private static class Scope2637 implements UpdateRuntimeScopeInterface {
