...
public class file_Test_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2709 scope = new Scope2709();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2709 scope)
    ...
    private static class Scope2709 implements UpdateRuntimeScopeInterface {
