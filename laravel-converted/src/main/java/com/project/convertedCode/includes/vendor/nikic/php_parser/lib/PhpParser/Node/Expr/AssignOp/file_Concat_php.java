...
public class file_Concat_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2060 scope = new Scope2060();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2060 scope)
            throws IncludeEventException {

        // Namespace import was here
        // Conversion Note: class named Concat was here in the source code
        env.addManualClassLoad("PhpParser\\Node\\Expr\\AssignOp\\Concat");
    }
    ...
    private static class Scope2060 implements UpdateRuntimeScopeInterface {
