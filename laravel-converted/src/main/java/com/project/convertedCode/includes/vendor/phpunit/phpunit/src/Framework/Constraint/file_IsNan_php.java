...
public class file_IsNan_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2561 scope = new Scope2561();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2561 scope)
    ...
    private static class Scope2561 implements UpdateRuntimeScopeInterface {
