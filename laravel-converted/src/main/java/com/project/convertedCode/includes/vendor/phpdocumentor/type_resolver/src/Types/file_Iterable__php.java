...
public class file_Iterable__php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2380 scope = new Scope2380();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2380 scope)
    ...
    private static class Scope2380 implements UpdateRuntimeScopeInterface {
