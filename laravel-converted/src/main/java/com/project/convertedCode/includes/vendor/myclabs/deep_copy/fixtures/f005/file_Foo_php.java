...
public class file_Foo_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope1917 scope = new Scope1917();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope1917 scope)
    ...
    private static class Scope1917 implements UpdateRuntimeScopeInterface {
