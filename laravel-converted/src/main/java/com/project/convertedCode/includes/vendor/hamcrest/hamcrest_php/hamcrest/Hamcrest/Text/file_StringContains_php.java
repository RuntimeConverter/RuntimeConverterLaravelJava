...
public class file_StringContains_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope846 scope = new Scope846();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope846 scope)
            throws IncludeEventException {

        // Conversion Note: class named StringContains was here in the source code
        env.addManualClassLoad("Hamcrest\\Text\\StringContains");
    }
    ...
    private static class Scope846 implements UpdateRuntimeScopeInterface {
