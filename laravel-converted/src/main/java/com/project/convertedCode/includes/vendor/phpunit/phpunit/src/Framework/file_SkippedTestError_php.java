...
public class file_SkippedTestError_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2648 scope = new Scope2648();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2648 scope)
    ...
    private static class Scope2648 implements UpdateRuntimeScopeInterface {
