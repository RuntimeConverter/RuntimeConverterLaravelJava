...
public class file_Location_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope2328 scope = new Scope2328();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope2328 scope)
    ...
    private static class Scope2328 implements UpdateRuntimeScopeInterface {
